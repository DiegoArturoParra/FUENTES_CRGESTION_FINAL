<%@ page title="" language="C#" masterpagefile="~/Master/Popup.master" autoeventwireup="true" inherits="Mantenimientos_Seguridad_MantOpcionDetalleOpcion, App_Web_ovdm0cuh" stylesheettheme="Standard" %>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center">
                            <asp:Button ID="btn_GRABAR" runat="server" Text="Grabar" Width="100px" OnClick="btn_GRABAR_Click"
                                OnClientClick="Validacion()" TabIndex="4" />
