<%@ page title="" language="C#" masterpagefile="~/Master/Popup.master" autoeventwireup="true" inherits="Mantenimientos_Seguridad_MantOpcionDetalle, App_Web_ovdm0cuh" stylesheettheme="Standard" %>
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center">
                            <asp:Button ID="btn_GRABAR" runat="server" Text="Grabar" Width="100px" OnClick="btn_GRABAR_Click"
                                OnClientClick="Validacion()" />
                            &nbsp;<asp:Button ID="btn_SALIR" runat="server" Text="Salir" Width="100px" OnClick="btn_SALIR_Click" />
                        </td>
                    </tr>
                </tbody>
            </table>
