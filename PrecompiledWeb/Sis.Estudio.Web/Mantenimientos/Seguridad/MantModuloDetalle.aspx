<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Mantenimientos_Seguridad_MantModuloDetalle, App_Web_ovdm0cuh" stylesheettheme="Standard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DefaultContent" runat="Server">
    <script language="javascript">
        ...
        function ValidaEliminacion() {
            ...
            if (Valida_Texto($get('<%= txt_IDPERFIL.ClientID %>').value) == false) {
                return;
            }
                                    ...
                                    <tbody>
                                        <tr >
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left; height: 7px;" 
                                                valign="top">
                                                <asp:TextBox ID="txt_IDPERFIL" runat="server" style="background-color:#cccccc"
                                        ...
                                        <tr >
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" 
                                                ...
                                                <asp:TextBox ID="txt_DESCRIPCION" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" Height="50px" MaxLength="100" TabIndex="2" 
                                        ...
                                        <tr>
                                            <td class="CeldaCabeceraEtiqueta" style="width: 23%; text-align: left;" 
                                                valign="top">
                                                <asp:Label ID="lbl_Url" runat="server" CssClass="labeltextonegro" 
                                                    Text="Url:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_URL" runat="server" CssClass="CajaTexto" ForeColor="Black" 
                                                    MaxLength="300" onkeydown="return SiguienteObjeto()" TabIndex="3" 
                                                    Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="CeldaCabeceraEtiqueta" style="width: 23%; text-align: left;" 
                                                valign="top">
                                                <asp:Label ID="lbl_Imgen" runat="server" CssClass="labeltextonegro" 
                                                    Text="Nombre Imgen:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_NOMIMAGEN" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return SiguienteObjeto()" 
                                        ...
                                        <tr>
                                            <td class="CeldaCabeceraEtiqueta" style="width: 23%; text-align: left;" 
                                                valign="top">
                                                <asp:Label ID="lbl_Lanzador" runat="server" CssClass="labeltextonegro" 
                                                    Text="Lanzador:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:CheckBox ID="chk_LANZADOR" runat="server" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
