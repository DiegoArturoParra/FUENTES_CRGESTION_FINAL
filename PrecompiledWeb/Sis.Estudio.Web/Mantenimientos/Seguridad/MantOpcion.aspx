<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Mantenimientos_Seguridad_MantOpcion, App_Web_ovdm0cuh" enableeventvalidation="true" stylesheettheme="Standard" %>
                ...
                <tr>
                    ...
                    <td style="width: 82%; text-align: right;">
                        ...
                        &nbsp;&nbsp;<asp:Button ID="btn_IMPRIMIR" runat="server" OnClick="btn_IMPRIMIR_Click"
                            ...
                            OnClientClick="" Text="&#9650; Mover" Width="100px" />
                        ...
                        &nbsp;<asp:Button ID="btn_MODIFICAR" runat="server" OnClick="btn_MODIFICAR_Click"
                            OnClientClick="Menu('m')" Text="Modificar" Width="100px" />
                            ...
                            <tr>
                                ...
                                <td style="width: 82%; text-align: right;">
                                    <asp:Button ID="btn_OpcionBajar" runat="server" OnClientClick="" Text="&#9650; Mover"
                                        Width="100px" OnClick="btn_OpcionBajar_Click" />
                                    ...
                                    <asp:Button ID="btn_NUEVO2" runat="server" OnClick="btn_NUEVO2_Click" 
                                        OnClientClick="Opcion('n')" Text="Agregar" Width="100px" />
                        ...
                        <asp:GridView ID="gv2" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                           ...
                           AutoGenerateColumns="False" AllowSorting="True"
                            ...
                            <PagerSettings FirstPageText="&amp;lt;&amp;lt;Primero" LastPageText="Ultimo&amp;gt;&amp;gt;"
                                Mode="NextPreviousFirstLast" NextPageText="Siguiente&amp;gt;" PreviousPageText="&amp;lt;Anterior" />
                            <RowStyle  Font-Names="Times New Roman" Font-Size="12px"  />
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                    <ItemStyle Width="1%"></ItemStyle>
                                    <HeaderStyle Width="1%"></HeaderStyle>
                ...
                <asp:UpdatePanel ID="up_GV3" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gv3" runat="server" Width="100%" EnableTheming="True" OnSorting="gv3_Sorting"
                            ...
                            AutoGenerateColumns="False" AllowSorting="True"
                            AllowPaging="True" OnSelectedIndexChanged="gv3_SelectedIndexChanged" PageSize="20">
                            <PagerSettings FirstPageText="&amp;lt;&amp;lt;Primero" LastPageText="Ultimo&amp;gt;&amp;gt;"
                                Mode="NextPreviousFirstLast" NextPageText="Siguiente&amp;gt;" PreviousPageText="&amp;lt;Anterior" />
                            <RowStyle  Font-Names="Times New Roman" Font-Size="12px" />
                            <Columns>
