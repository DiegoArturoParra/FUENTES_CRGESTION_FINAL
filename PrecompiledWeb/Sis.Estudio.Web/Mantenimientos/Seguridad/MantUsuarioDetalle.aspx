<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Mantenimientos_Seguridad_MantUsuarioDetalle, App_Web_ovdm0cuh" stylesheettheme="Standard" %>
                                        ...
                                        <td class="CeldaCabeceraEtiqueta" 
                                            ...
                                            <asp:Panel ID="Panel2" runat="server" CssClass="BarraCollaps" Height="18px" 
                                                ...
                                                <asp:Label ID="lbl_MP" runat="server" CssClass="labeltextonegro" 
                                                    Font-Bold="True" Font-Size="Small" ForeColor="#000040" Height="18px" 
                                                    Width="95%">Modificar Password</asp:Label>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" style="text-align: center">
                                                            &nbsp;<asp:Button ID="btn_MODIFICARPASS" runat="server" 
                                                                OnClick="btn_MODIFICARPASS_Click" Text="Grabar" Width="70px" />
                                                            <asp:Button ID="btn_CANCELAMODIFICARPASS" runat="server" 
                                                                OnClick="btn_CANCELAMODIFICARPASS_Click" Text="Cancelar" Width="70px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
