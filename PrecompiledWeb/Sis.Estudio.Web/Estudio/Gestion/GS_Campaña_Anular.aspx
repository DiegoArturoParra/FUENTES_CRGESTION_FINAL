<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_Campaña_Anular, App_Web_0nt2mo3d" stylesheettheme="Standard" %>
    ...
    <tr>
        ...
        <td style="height: 28px;">
            ...
            <asp:Button ID="btnAnular" runat="server" CausesValidation="False" 
                ...
                onclick="btnAnular_Click" BackColor="#1F529E" ForeColor="White" />
        </td>
    </tr>
</table>
