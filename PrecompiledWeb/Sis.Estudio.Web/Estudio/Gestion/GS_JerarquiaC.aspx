<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_JerarquiaC, App_Web_kou4i3xh" stylesheettheme="Standard" %>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="desc_jerarquiaC" HeaderText="Descripción Jerarquia Nivel C" SortExpression="desc_jerarquiaC">
                                                <ItemStyle Width="30%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
