<%@ page title="" language="C#" masterpagefile="~/Master/Ficha.master" autoeventwireup="true" inherits="Estudio_Gestion_08FrmGaranxProduc, App_Web_kou4i3xh" stylesheettheme="Standard" %>
                ...
                <tr id="botoneraGarantia">
                    <td  style="text-align:right;">
                            <asp:Button ID="btn_MantGarantia" runat="server" Text="Mantenimiento" 
                                onclick="btn_MantGarantia_Click" BackColor="#1F529E" ForeColor="White" 
                                 ></asp:Button>
                    </td>
                </tr>
            </table>           
