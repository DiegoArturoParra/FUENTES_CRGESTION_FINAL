<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_UbigeoColindante, App_Web_kou4i3xh" stylesheettheme="Standard" %>
        ...
        <td style="height: 28px;">
            ...
            <asp:Button ID="btnEliminar" runat="server" CausesValidation="False" 
               style="height: 26px" Text="Eliminar" Width="120px" 
                onclick="btnEliminar_Click" BackColor="#1F529E" ForeColor="White" />
            <asp:Button ID="btnAgregar" runat="server" CausesValidation="False" 
                style="height: 26px" Text="Agregar" 
                Width="120px" onclick="btnAgregar_Click" BackColor="#1F529E" 
                ForeColor="White" />
        </td>
    </tr>
</table>
