<%@ page title="" language="C#" masterpagefile="~/Master/Ficha.master" autoeventwireup="true" inherits="Estudio_Gestion_06FrmProduCliente, App_Web_0nt2mo3d" stylesheettheme="Standard" %>
                        ...
                        <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="IdReg" HeaderText="Codigo">
                                    <ItemStyle Width="9%" HorizontalAlign="Left" Height="15px" Font-Bold="False"  CssClass="hidden"></ItemStyle>
                ...
                <tr id="Botones">
                    <td  style="text-align:right;">
                            <asp:Button ID="btn_MantProducto" runat="server" Text="Mantenimiento" 
                                onclick="btn_MantProducto_Click" BackColor="#1F529E" ForeColor="White"></asp:Button>
                    </td>
                </tr>
            </table>
            <table width="100%" >
                    ...
                    <td style="width: 60%;" valign="top">
                        <table cellpadding="1" cellspacing="0" border="0" style="width: 100%">                                    
                            ...
                            AllowSorting="True" PageSize="20" 
                                        onselectedindexchanged="gv_Gastos_SelectedIndexChanged" >
                            <PagerSettings PreviousPageText="&amp;lt;Anterior" Mode="NextPreviousFirstLast" LastPageText="Ultimo&amp;gt;&amp;gt;"
                                FirstPageText="&amp;lt;&amp;lt;Primero" NextPageText="Siguiente&amp;gt;"></PagerSettings>
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                                                ...
                                                <table border="0" cellpadding="1" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td style="text-align: center; width: 306px;">
                                                            &nbsp;<asp:Button ID="btn_Agregar_Gastos" runat="server" BackColor="#1F529E" 
                                                                ForeColor="White" Text="Agregar" Width="100px" 
                                                                onclick="btn_Agregar_Gastos_Click" />
                                                            &nbsp;<asp:Button ID="btn_Modificar_Gastos" runat="server" BackColor="#1F529E" 
                                                                ForeColor="White" Text="Modificar" Width="100px" 
                                                                onclick="btn_Modificar_Gastos_Click" />
                                                            &nbsp;&nbsp;<asp:Button ID="btn_Grabar_Gastos" runat="server" BackColor="#1F529E" 
                                                                ForeColor="White" Text="Grabar" Width="100px" 
                                                                onclick="btn_Grabar_Gastos_Click" />
                                                            &nbsp;<asp:Button ID="btn_Cancelar_Gastos" runat="server" BackColor="#1F529E" 
                            ...
                            AllowSorting="True" PageSize="20" onselectedindexchanged="gv_GC_SelectedIndexChanged" 
                                        Height="110px" style="margin-top: 20px" >
                            <PagerSettings PreviousPageText="&amp;lt;Anterior" Mode="NextPreviousFirstLast" LastPageText="Ultimo&amp;gt;&amp;gt;"
                                FirstPageText="&amp;lt;&amp;lt;Primero" NextPageText="Siguiente&amp;gt;"></PagerSettings>
                            <Columns>
                                <asp:TemplateField ShowHeader="False">
                            ...
                            <RowStyle Font-Names="Times New Roman" Font-Size="4px"></RowStyle>
                            <EmptyDataTemplate>
                                <table id="tbSinDatos">
                                    <tbody>
                                        <tr>
