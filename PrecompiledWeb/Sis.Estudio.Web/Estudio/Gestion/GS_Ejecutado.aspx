<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_Ejecutado, App_Web_kou4i3xh" stylesheettheme="Standard" %>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodEjecutado" HeaderText="Codigo Ejecutado" SortExpression="CodEjecutado">
                                          ...
                                          <asp:BoundField DataField="Desc_CodTipoGestion" HeaderText="Desc. Codigo Tipo de Gestión" SortExpression="Desc_CodTipoGestion">
