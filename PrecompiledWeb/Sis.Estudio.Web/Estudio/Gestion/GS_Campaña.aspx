<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_Campaña, App_Web_kou4i3xh" stylesheettheme="Standard" %>
    ...
    <tr>
        ...
        <td style="height: 28px;">
            ...
            <asp:Button ID="btnGrabar" runat="server" CausesValidation="False" 
                ...
                onclick="btnGrabar_Click" BackColor="#1F529E" ForeColor="White" />
        </td>
    </tr>
</table>
