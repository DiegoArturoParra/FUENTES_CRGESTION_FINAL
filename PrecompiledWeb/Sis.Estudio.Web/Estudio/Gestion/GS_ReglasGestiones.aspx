<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_ReglasGestiones, App_Web_kou4i3xh" stylesheettheme="Standard" %>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="id_ReglasGestiones" HeaderText="id_ReglasGestiones" SortExpression="id_ReglasGestiones">
                                            ...
                                            <asp:BoundField DataField="desc_ejecutores" HeaderText="desc_ejecutores" SortExpression="desc_ejecutores">
                                                <ItemStyle Width="40%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="40%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="dias_mora_de" HeaderText="dias_mora_de" SortExpression="dias_mora_de">
                                                <ItemStyle Width="10%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="10%" CssClass="" Height="22px"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="dias_mora_hasta" HeaderText="dias_mora_hasta" SortExpression="dias_mora_hasta">
                                                <ItemStyle Width="10%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="10%" CssClass="" Height="22px"></HeaderStyle>
                                            </asp:BoundField>
                                          ...
                                          <asp:BoundField DataField="garantias" HeaderText="garantias" SortExpression="garantias">
                                                <ItemStyle Width="30%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="30%" CssClass="" Height="22px"></HeaderStyle>
                                            </asp:BoundField>
