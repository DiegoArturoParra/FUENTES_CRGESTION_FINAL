<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_Gestion_Cobranza_Bandeja_Salida, App_Web_kou4i3xh" stylesheettheme="Standard" %>
                        ...
                        <table id="Controles" align="center" border="0" cellpadding="0" cellspacing="0" class="cabeceraScroll"
                            ...
                            <tr>
                                <td align="left" colspan="2" style="height: 47px; text-align: center;">
                                    <asp:Button ID="btnGrabarObs" runat="server" BackColor="#1F529E" 
