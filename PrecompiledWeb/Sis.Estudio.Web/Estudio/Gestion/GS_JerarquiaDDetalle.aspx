<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_JerarquiaDDetalle, App_Web_0nt2mo3d" stylesheettheme="Standard" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_JerarquiaA" runat="server" TabIndex="6" Width="100%" AutoPostBack="True"  
                                        ...
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_JerarquiaC" runat="server" TabIndex="6" Width="100%" 
                                                    >
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_descripcion" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="250" onkeydown="return SiguienteObjeto()" 
