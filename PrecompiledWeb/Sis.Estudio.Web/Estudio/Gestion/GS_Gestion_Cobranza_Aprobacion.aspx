<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_Gestion_Cobranza_Aprobacion, App_Web_0nt2mo3d" stylesheettheme="Standard" %>
                        ...
                        <table id="Controles" align="center" border="0" cellpadding="0" cellspacing="0" class="cabeceraScroll"
                            ...
                            <tr>
                                <td align="left" colspan="2" style="height: 47px; text-align: center;">
                                    <asp:Button ID="btnAprobar" runat="server" BackColor="#1F529E" 
                                    ...
                                    <asp:Button ID="btnRechazar" runat="server" BackColor="#1F529E" 
                                        BorderStyle="Ridge" CausesValidation="False" Font-Names="Times New Roman" 
