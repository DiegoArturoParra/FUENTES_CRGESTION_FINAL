<%@ page title="" language="C#" masterpagefile="~/Master/Ficha.master" autoeventwireup="true" inherits="Estudio_Gestion_01FrmDatosClienteDet, App_Web_0nt2mo3d" stylesheettheme="Standard" %>
            ...
            <tr id="Botones">
                <td colspan="8" style="text-align: center">
                    <asp:Button ID="btn_Grabar" runat="server" Text="Grabar" Width="100px" 
                        OnClick="btn_Grabar_Click" BackColor="#1F529E" ForeColor="White">
                    </asp:Button>
                    <asp:Button ID="btn_Retornar" runat="server" Text="Regresar" Width="100px" 
                        OnClick="btn_Retornar_Click" BackColor="#1F529E" ForeColor="White">
                    </asp:Button>
                </td>
            </tr>
        </tbody>
