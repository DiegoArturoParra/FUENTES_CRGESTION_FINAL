<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_Reasignacion_Cartera_Interna, App_Web_zwoktu4b" stylesheettheme="Standard" %>
                ...
                <tr>
                    <td align="left" style="width: 100%;" rowspan="2">
                        ...
                        <asp:Button ID="btnReasignar" runat="server" BackColor="#1F529E" 
                            BorderStyle="Ridge" CausesValidation="False" Font-Names="Times New Roman" 
                            Font-Size="9pt" ForeColor="White" Height="25px" OnClick="btnReasignar_Click" 
                            Text="Reasignar" Width="90px" />
                    </td>
                </tr>
            </table>
                        ...
                        <table id="Controles" align="center" border="0" cellpadding="0" cellspacing="0" class="cabeceraScroll"
                            ...
                            <tr>
                                <td align="left" style="width: 331px">
                                    Agente: </td>
                                <td align="left" width="">
                                    <asp:DropDownList ID="cmb_Agente" runat="server" TabIndex="6" 
                                        Width="100%">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                ...
                <tr>
                    <td align="center" style="width: 100%;">
                        <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" AutoGenerateColumns="False"
                            ...
                            OnPageIndexChanged="gv_PageIndexChanged" PageSize="40">
