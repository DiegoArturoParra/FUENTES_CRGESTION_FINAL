<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_Gestion_CarteraCobranza, App_Web_kou4i3xh" stylesheettheme="Standard" %>
...
<table border="0" cellpadding="0" cellspacing="0" class="cabeceraScroll" style="width: 100%">
    <tr>
        ...
        <td style="height: 28px;">
            ...
            <asp:Button ID="btnConsultar" runat="server" CausesValidation="False" 
                 Text="Consultar" Width="100px" onclick="btnConsultar_Click" 
                                                ...
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" 
                                                    ...
                                                    <tr>
                                                        <td align="left" style="width: 331px">
                                                            Jerarquía:</td>
                                                        <td align="left" width="">
                                                            <asp:TextBox ID="txt_desc_jerarquia" runat="server" Enabled="false" 
