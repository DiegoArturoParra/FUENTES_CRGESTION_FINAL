<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_CartaDetalle, App_Web_kou4i3xh" stylesheettheme="Standard" %>
                                        ...
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_descripcion" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="5000" onkeydown="return SiguienteObjeto()" 
                                                    TabIndex="1" Width="99%"  Height="76px" 
                                                    ontextchanged="txt_descripcion_TextChanged" TextMode="MultiLine" 
