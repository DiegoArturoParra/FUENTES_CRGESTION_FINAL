<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_EjecutadoDetalle, App_Web_0nt2mo3d" stylesheettheme="Standard" %>
                                ...
                                <table align="center" border="0" cellpadding="4" cellspacing="1" 
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_dias" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return Control_Numero(event)" 
                                                    TabIndex="1" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                ...
                                <tbody>
                                    <tr bgcolor="#999999">
                                        <td class="" colspan="3" style="text-align: center;" valign="top">
                                            <asp:Label ID="lbl_FECHAREGISTRA21" runat="server" CssClass="labeltextoblanco" 
