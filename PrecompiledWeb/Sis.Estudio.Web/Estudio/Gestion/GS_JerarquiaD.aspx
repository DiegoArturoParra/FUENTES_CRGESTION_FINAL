<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_JerarquiaD, App_Web_kou4i3xh" stylesheettheme="Standard" %>
  ...
  <tr>
    ...
    <td style="height: 28px;">
        ...
        <asp:Button ID="btnLimpiar" runat="server" CausesValidation="False" 
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px" BackColor="#1F529E" 
            ForeColor="White" />
      </td>
  </tr>
</table>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="cod_jerarquiaD" HeaderText="Jerarquia Nivel D" SortExpression="cod_jerarquiaD">
                                            ...
                                            <asp:BoundField DataField="desc_jerarquiaD" HeaderText="Descripción Jerarquia Nivel D" SortExpression="desc_jerarquiaD">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="20%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="cod_jerarquiaC" HeaderText="Jerarquia Nivel C" SortExpression="cod_jerarquiaC">
                                                <ItemStyle Width="5%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="5%" CssClass="" Height="22px"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="desc_jerarquiaC" HeaderText="Descripción Jerarquia Nivel C" SortExpression="desc_jerarquiaC">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="20%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="cod_jerarquiaB" HeaderText="Jerarquia Nivel B" SortExpression="cod_jerarquiaB">
                                                <ItemStyle Width="5%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="5%" CssClass="" Height="22px"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="desc_jerarquiaB" HeaderText="Descripción Jerarquia Nivel B" SortExpression="desc_jerarquiaB">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="20%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="cod_jerarquiaA" HeaderText="Jerarquia Nivel A" SortExpression="cod_jerarquiaA">
                                                <ItemStyle Width="5%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="5%" CssClass="" Height="22px"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="desc_jerarquiaA" HeaderText="Descripción Jerarquia Nivel A" SortExpression="desc_jerarquiaA">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="20%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>
