<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_JerarquiaBDetalle, App_Web_kou4i3xh" stylesheettheme="Standard" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" 
                                                valign="top">
                                                <asp:DropDownList ID="cmb_JerarquiaA" runat="server" TabIndex="6" 
                                                    Width="100%">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
