<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_ClaseGestiones, App_Web_0nt2mo3d" stylesheettheme="Standard" %>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodClaseGestion" HeaderText="Codigo Clase de Gestiones" SortExpression="CodClaseGestion">
                                            ...
                                            <asp:BoundField DataField="Descripcion" HeaderText="Descripción Clase de Gestiones" SortExpression="Descripcion">
