<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_EstadoDireccionDet, App_Web_rinb4jmc" stylesheettheme="Standard" %>
                                        ...
                                        <tr >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" 
                                                ...
                                                <asp:Label ID="lbl_Nombre" runat="server" CssClass="Item" 
                                                    Text="Estado Dirección:"></asp:Label>
                                            </td>
