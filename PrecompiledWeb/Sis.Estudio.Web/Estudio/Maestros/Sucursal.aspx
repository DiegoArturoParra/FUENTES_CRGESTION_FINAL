<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_Sucursal, App_Web_rinb4jmc" stylesheettheme="Standard" %>
            ...
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px" Visible="False" />
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodSucursal" HeaderText="Codigo" SortExpression="CodSucursal">
                                            ...
                                            <asp:BoundField DataField="CodSucursal">
                                            ...
                                            <asp:BoundField DataField="CodigoInterno" HeaderText="Codigo Interno" SortExpression="CodigoInterno">
