<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_SubProducto, App_Web_rinb4jmc" stylesheettheme="Standard" %>
            ...
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px" Visible="False" />
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="codSubProducto" HeaderText="Codigo" SortExpression="codSubProducto">
                                            ...
                                            <asp:BoundField DataField="codSubProducto">
                                            ...
                                            <asp:BoundField DataField="SubProducto" HeaderText="SubProducto" SortExpression="SubProducto">
                                                <ItemStyle Width="30%" HorizontalAlign="Left" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="30%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="CodigoInterno" HeaderText="CodigoInterno" SortExpression="CodigoInterno">
