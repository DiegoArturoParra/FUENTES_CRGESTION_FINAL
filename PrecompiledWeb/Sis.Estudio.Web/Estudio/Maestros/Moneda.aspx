<%@ page language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_Moneda, App_Web_rinb4jmc" stylesheettheme="Standard" %>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodMoneda" HeaderText="Codigo Moneda" SortExpression="CodMoneda">
                                            ...
                                            <asp:BoundField DataField="DesMoneda" HeaderText="Descripción" SortExpression="DesMoneda">
