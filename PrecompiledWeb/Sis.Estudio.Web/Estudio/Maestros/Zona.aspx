<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_Zona, App_Web_rinb4jmc" stylesheettheme="Standard" %>
            ...
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px" Visible="False" />
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodZona" HeaderText="Codigo" SortExpression="CodZona">
                                            ...
                                            <asp:BoundField DataField="CodZona">
