<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_CalificacionSBS, App_Web_rinb4jmc" stylesheettheme="Standard" %>
  ...
  <tr>
    ...
    <td style="height: 28px;">
        ...
        <asp:Button ID="btnLimpiar" runat="server" CausesValidation="False" 
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px" Visible="False" />
      </td>
  </tr>
</table>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodCalificacionSBS" HeaderText="Codigo" SortExpression="CodCalificacionSBS">
                                            ...
                                            <asp:BoundField DataField="CodCalificacionSBS">
                                                <ItemStyle CssClass="hidden"></ItemStyle>
                                                <HeaderStyle CssClass="hidden"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="CalificacionSBS" HeaderText="Descripcion" SortExpression="CalificacionSBS">
                                                <ItemStyle Width="40%" HorizontalAlign="Left" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="40%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="IniDiasMora" HeaderText="Inicio Mora" SortExpression="IniDiasMora">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="20%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="FinDiasMora" HeaderText="Fin Mora" SortExpression="FinDiasMora">
                                                <ItemStyle Width="20%" HorizontalAlign="Left" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="20%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>
