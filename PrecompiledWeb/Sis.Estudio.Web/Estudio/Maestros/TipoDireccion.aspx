<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_TipoDireccion, App_Web_rinb4jmc" stylesheettheme="Standard" %>
            ...
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px" Visible="False" />
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodTipoDir" HeaderText="Codigo" SortExpression="CodTipoDir">
                                            ...
                                            <asp:BoundField DataField="CodTipoDir">
                                                <ItemStyle CssClass="hidden"></ItemStyle>
                                                <HeaderStyle CssClass="hidden"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="TipoDireccion" HeaderText="Descripcion" SortExpression="TipoDireccion">
