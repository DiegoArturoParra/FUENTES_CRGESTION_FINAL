<%@ page language="C#" autoeventwireup="true" inherits="Estudio_Reportes_ContencionGestionC, App_Web_r2n2tuxx" stylesheettheme="Standard" %>
    ...
    <form id="form1" runat="server">
            ...
            <div>
                <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
                    <Report FileName="ContencionGestion.rpt">
                    </Report>
