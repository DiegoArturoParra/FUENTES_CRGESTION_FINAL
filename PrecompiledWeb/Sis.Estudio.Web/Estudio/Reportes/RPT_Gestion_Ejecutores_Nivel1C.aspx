<%@ page language="C#" autoeventwireup="true" inherits="Estudio_Reportes_RPT_Gestion_Ejecutores_Nivel1C, App_Web_r2n2tuxx" stylesheettheme="Standard" %>
    ...
    <form id="form1" runat="server">
      ...
      <div style="width: 254px">
                <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
                    <Report FileName="RPT_Gestion_Ejecutores_Nivel1.rpt">
                    </Report>
