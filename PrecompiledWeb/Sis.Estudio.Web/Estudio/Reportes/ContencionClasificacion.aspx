<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Reportes_ContencionClasificacion, App_Web_r2n2tuxx" stylesheettheme="Standard" %>
            ...
            <td style="width: 1000px;" align="left">
                <table cellpadding="1" cellspacing="0" border="0" style="width: 600px">                            
                    ...
                    <tr id="Clasificacion">
                        ...
                        <td style="text-align: left; width: 400px;">
                            <asp:DropDownList ID="cmb_Clasificacion" runat="server" AutoPostBack="True" 
                                TabIndex="1" Width="98%" 
                                onselectedindexchanged="cmb_Clasificacion_SelectedIndexChanged">
                            </asp:DropDownList>
                        </td>
                        <td>
