<%@ page title="" language="C#" masterpagefile="~/Master/Popup.master" autoeventwireup="true" inherits="Consultas_Busquedas_BuscarPerfil, App_Web_fhace2t1" stylesheettheme="Standard" %>
                                ...
                                <ContentTemplate>
                                    <table id="tbToolbarSuperior" cellpadding="0" cellspacing="0" class="cabeceraScroll"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="width: 25%">
                                                    <asp:Label ID="lblPaginado" runat="server" CssClass="labeltextonegro">Paginado</asp:Label>&nbsp;<asp:DropDownList
                                                ...
                                                <td style="width: 20%; text-align: left">
                                                    <asp:Label ID="lblPaginaIr" runat="server" CssClass="labeltextonegro">Ir a </asp:Label>&nbsp;<asp:DropDownList ID="ddlPaginaIr"
                                            ...
                                            <td style="height: 32px">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="left" width="">
                                                            <asp:TextBox ID="txt_NOMBRE" runat="server" onkeydown="return Enter_Buscar(event)"
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Descripcion" HeaderText="Descripcion Perfil">
                                    ...
                                    <asp:Button ID="btn_SELECCIONAR" runat="server" Height="25px" OnClick="btn_SELECCIONAR_Click"
                                        Text="Seleccionar" Width="239px" />
                                </ContentTemplate>
                                <Triggers>
