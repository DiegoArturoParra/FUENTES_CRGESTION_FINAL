<%@ page language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Reportes_RPT_Gerencia_RollRates_Tramo, App_Web_ttsq0jlp" stylesheettheme="Standard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DefaultContent" runat="server">
    <script type="text/javasript">
            function onFolder(){
                ...
                var path = "~/ReportesGerencialesModelo/RollRates-12042017-161125.xlsx";
                var x = path;
                return x;
            }
    </script>
