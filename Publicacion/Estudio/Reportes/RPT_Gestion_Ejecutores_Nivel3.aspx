<%@ page language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Reportes_RPT_Gestion_Ejecutores_Nivel3, App_Web_ttsq0jlp" stylesheettheme="Standard" %>
            ...
            <table id="Botones" border="0" cellpadding="0" cellspacing="0" class="cabeceraScroll"
                ...
                <tr>
                    <td align="left" style="width: 100%;" >
                        <asp:Button ID="btn_Excel" runat="server" BackColor="#98a2b4
...
" BorderStyle="Ridge"
                        ...
                        <asp:Button ID="btn_Imprimir" runat="server" BackColor="#98a2b4" BorderStyle="Ridge"
                            CausesValidation="False" Font-Names="Trebuchet MS" Font-Size="9pt" ForeColor="White"
                                        ...
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="width: 30%; text-align: left;">
                                                    <asp:DropDownList ID="cmb_Anio" runat="server" Font-Size="Small" TabIndex="3" Width="98%">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="width: 10%; text-align: left;">
                                                </td>
