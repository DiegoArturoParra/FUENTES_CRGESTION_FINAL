<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_TipoGestiones, App_Web_m4xi2a1f" stylesheettheme="Standard" %>
    ...
    <td style="height: 28px; width: 348px;">
        <table cellpadding="1" cellspacing="0" class="clsToolbar" width="120px">
            <tr>
                ...
                <td width="23">
                    <asp:Button ID="btnAgregar" runat="server" onclick="btnAgregar_Click" Text="Agregar" BackColor="#000080" ForeColor="White" Width="110px"/>
                </td>
                <td width="23">
                    <asp:Button ID="btnModificar" runat="server" onclick="btnModificar_Click"  Text="Modificar" BackColor="#000080" ForeColor="White" Width="110px"/>
                </td>
                <td width="23">
                    <asp:Button ID="btnConsultar" runat="server"  onclick="btnConsultar_Click"  Text="Consultar" BackColor="#000080" ForeColor="White" Width="110px"/>
                </td>
                <td width="23">
                    <asp:Button ID="btnEliminar" runat="server" onclick="btnEliminar_Click"  Text="Eliminar" BackColor="#000080" ForeColor="White" Width="110px"/>
                </td>
                <td width="23">
                    <asp:Button ID="btnExcel" runat="server"  onclick="btnExcel_Click"
                        OnClientClick ="Valida_Todos()" Visible="False"  Text="Excel" BackColor="#000080" ForeColor="White" Width="110px"/>
                </td>
                <td width="23">
                    <asp:Button ID="btnImprimir" runat="server" onclick="btnImprimir_Click" 
                        onclientclick="Valida_Todos()"  Text="Imprimir" BackColor="#000080" ForeColor="White" Width="110px"/>
                </td>
                <td width="23">
                    <asp:Button ID="btnSalir" runat="server" onclick="btnSalir_Click" Visible=false  Text="Salir" BackColor="#000080" ForeColor="White" Width="110px"/>
                </td>
                <td style="text-align: center" valign="middle" width="10">
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodTipoGestion" HeaderText="Codigo Tipo de Gestión" SortExpression="CodTipoGestion">
                                            ...
                                            <asp:BoundField DataField="Descripcion" HeaderText="Action Plan" SortExpression="Descripcion">
                                                <ItemStyle Width="45%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="45%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>
                                            ...
                                            <asp:BoundField DataField="Proc_auto" HeaderText="Proc_auto" SortExpression="Proc_auto">
