<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_ReglasGestiones, App_Web_m4xi2a1f" stylesheettheme="Standard" %>
    ...
    <tr>
        ...
        <td align="left" width="">
            <asp:TextBox ID="txt_DESCRIPCION" runat="server" 
                onkeydown="return Enter_Buscar(event)" Width="466px"></asp:TextBox>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="id_ReglasGestiones" HeaderText="Código" SortExpression="id_ReglasGestiones">
                                                <ItemStyle Width="10%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="10%" CssClass="" Height="20px"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="desc_ejecutores" HeaderText="Ejecutor" SortExpression="desc_ejecutores">
                                                <ItemStyle Width="26%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="26%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="dias_mora_de" HeaderText="Día de mora inicial" SortExpression="dias_mora_de">
                                                <ItemStyle Width="12%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="12%" CssClass="" Height="20px"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="dias_mora_hasta" HeaderText="Día de mora final" SortExpression="dias_mora_hasta">
                                                <ItemStyle Width="12%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="12%" CssClass="" Height="20px"></HeaderStyle>
                                            </asp:BoundField>
                                          ...
                                          <asp:BoundField DataField="descripcion" HeaderText="Descripción" SortExpression="descripcion">
                                                ...
                                                <HeaderStyle Width="20%" CssClass="" Height="20px"></HeaderStyle>
                                            </asp:BoundField>



                                                 <asp:BoundField DataField="Tramos" HeaderText="Tramo" 
                                                SortExpression="Descrip">
                                                <ItemStyle Width="30%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="30%" CssClass="" Height="30px"></HeaderStyle>
                                            </asp:BoundField>

                                          <asp:BoundField DataField="garantias" HeaderText="Garantía" SortExpression="garantias">
                                                <ItemStyle Width="30%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="30%" CssClass="" Height="22px"></HeaderStyle>
                                            </asp:BoundField>

                                          <asp:BoundField DataField="provisiones" HeaderText="Provisiones" SortExpression="provisiones">
                                                <ItemStyle Width="30%" HorizontalAlign="Left" Height="15px" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="30%" CssClass="" Height="22px"></HeaderStyle>
                                            </asp:BoundField>
