<%@ page title="" language="C#" masterpagefile="~/Master/Ficha.master" autoeventwireup="true" inherits="Estudio_Gestion_07FrmClieProdAval, App_Web_m4xi2a1f" stylesheettheme="Standard" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <contenttemplate>
            ...
            <table width="100%" >
                ...
                <tr id="Titulo_Aval">
                    <td class="encebezadotabla-3" style="width: 98%; text-align:center; background-color:#000080; color:white;">
                ...
                <tr id="GridAval">
                    <td style="width: 100%;" valign="top">
                        <asp:GridView ID="gv_Aval" runat="server" Width="100%" EnableTheming="True" AutoGenerateColumns="False"
                            AllowSorting="True" PageSize="20" 
                            onselectedindexchanged="gv_Aval_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" >
                            <FooterStyle BackColor="White" ForeColor="#000066" />
                ...
                <tr id="BotonesAval">
                    <td  style="text-align:right;">
                            <asp:Button ID="btn_MantAval" runat="server" Text="Mantenimiento" 
                                onclick="btn_MantAval_Click" BackColor="#000080" ForeColor="White" ></asp:Button>
                    </td>
                </tr>
            </table>
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td  style="text-align:right;">
                            <asp:Button ID="btn_MantAvalPatri" runat="server" Text="Mantenimiento" 
                                onclick="btn_MantAvalPatri_Click" BackColor="#000080" ForeColor="White" ></asp:Button>
                    </td>
                    </tr>
                    </table>
                        ...
                        <tr id="botonera_avaldireccion">
                            <td  style="text-align:right;">
                                    <asp:Button ID="btn_MantAvalDirec" runat="server" Text="Mantenimiento" 
                                        onclick="btn_MantAvalDirec_Click" BackColor="#000080" ForeColor="White" ></asp:Button>
                            </td>
                        </tr>
                    </table>
                    </td>
