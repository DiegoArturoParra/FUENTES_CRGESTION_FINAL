<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_ClaseGestiones, App_Web_hhkm3gt1" stylesheettheme="Standard" %>
...
<table border="0" cellpadding="0" cellspacing="0" class="cabeceraScroll" style="width: 100%">
  <tr>
    ...
    <td style="height: 28px; width: 356px;">
    ...
    <td style="height: 28px;">
        <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" 
            onclientclick="Valida_Todos()" TabIndex="1" Text="Buscar" Width="85px" Height="26px" Font-Bold="true" 
             ForeColor="White" BackColor="#000080"/>
        <asp:Button ID="btnLimpiar" runat="server" CausesValidation="False" 
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="85px" Height="26px" Font-Bold="true"
             ForeColor="White" BackColor="#000080"/>
      </td>
  </tr>
</table>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodClaseGestion" HeaderText="Código" SortExpression="CodClaseGestion">
                                            ...
                                            <asp:BoundField DataField="Descripcion" HeaderText="Resultado" SortExpression="Descripcion">
                                                <ItemStyle Width="40%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="40%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="CodTipoGestion" HeaderText="CodTipoGestion" SortExpression="CodTipoGestion">
                                          ...
                                          <asp:BoundField DataField="Desc_CodTipoGestion" HeaderText="Action Plan" SortExpression="Desc_CodTipoGestion">
