<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_TipoGestionesDetalle, App_Web_m4xi2a1f" stylesheettheme="Standard" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="lbl_FECHAREGISTRA18" runat="server" CssClass="Item" 
                                                    Text="Tiempo:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_tiempo" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return Control_Numero(event)" 
                                                    TabIndex="1" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_grupo" runat="server" TabIndex="6" Width="100%">
                                                    <asp:ListItem Value="1">Action Plan Saliente: Asesor - Cliente</asp:ListItem>
                                                    <asp:ListItem Value="2">Action Plan Entrante: Cliente - Asesor</asp:ListItem>
                                                    <asp:ListItem Value="3">Action Plan de Gestión Interna</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="lbl_FECHAREGISTRA19" runat="server" CssClass="Item" 
                                                    Text="Proceso Automático:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_proc_auto" runat="server" TabIndex="6" Width="100%">
                                        ...
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="label_FLUJO" runat="server" CssClass="Item" 
                                                    Text="Flujo del Action Plan:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_flujo" runat="server" TabIndex="6" Width="100%">
                                                    <asp:ListItem Value="1">Gestión Directa (Asesor-Cliente/Cliente-Asesor)</asp:ListItem>
                                                    <asp:ListItem Value="2">Derivar a Bandeja de Ejecuciones Internas</asp:ListItem>
                                                    <asp:ListItem Value="3">Modificar el Flujo de la Gestión</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="label_FLAGFECHAVISITA" runat="server" CssClass="Item" 
                                                    Text="Requiere Fecha:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_flag_visita" runat="server" TabIndex="6" Width="100%">
                                                    <asp:ListItem Value="0">No</asp:ListItem>
                                                    <asp:ListItem Value="1">Si</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="labe_FLAGGENERANUEVO" runat="server" CssClass="Item" 
                                                    Text="Genera Nuevo AP:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_flag_generanuevo" runat="server" TabIndex="6" Width="100%">
                                                    <asp:ListItem Value="0">No</asp:ListItem>
                                                    <asp:ListItem Value="1">Si</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="Label1" runat="server" CssClass="Item" 
                                                    Text="Proceso Masivo:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_flag_procesomasivo" runat="server" TabIndex="6" Width="100%">
                                                    <asp:ListItem Value="0">No es Masivo</asp:ListItem>
                                                    <asp:ListItem Value="1">Masivo mediante celular</asp:ListItem>
                                                    <asp:ListItem Value="2">Masivo mediante correo</asp:ListItem>
                                                    <asp:ListItem Value="3">Masivo mediante cartas</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </tbody>
