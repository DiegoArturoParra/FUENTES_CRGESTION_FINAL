<%@ page title="" language="C#" masterpagefile="~/Master/Ficha.master" autoeventwireup="true" inherits="Estudio_Gestion_01FrmDatosCliente, App_Web_5d2q0ozo" stylesheettheme="Standard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <contenttemplate>
            <table width="100%" border="0"  cellspacing="0" class="cabeceraScroll">
                <tbody>                                    
                    ...
                    <tr>
                        <%--#c0c0c0--%>
                        <td bgcolor="" colspan="8" style="height: 25px">
                        </td>
                    </tr>
                    ...
                    <td colspan="6"></td>
                        <td colspan="2" style="text-align:left;">
                             <asp:Button ID="btn_Modificar" runat="server" Text="Modificar" 
                                 onclick="btn_Modificar_Click" BackColor="#000080" ForeColor="White"></asp:Button>
                        </td>
