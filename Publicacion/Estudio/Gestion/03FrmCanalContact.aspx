<%@ page title="" language="C#" masterpagefile="~/Master/Ficha.master" autoeventwireup="true" inherits="Estudio_Gestion_03FrmCanalContact, App_Web_m4xi2a1f" stylesheettheme="Standard" %>
                                ...
                                <td style="width: 100%;" align="center">
                                    <table cellpadding="1" cellspacing="0" border="0" style="width: 100%">
                                        <tr id="IdReg" class="hidden">
                                            ...
                                            <td style="text-align: left; width: 70%;" class="">
                                        ...
                                        <tr id="TipoContacto">
                                            ...
                                            <td style="text-align: left; width: 70%;">
                                                <asp:DropDownList ID="cmb_TipoContacto" runat="server" AutoPostBack="True" TabIndex="1"
                                                Width="90%" >
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="Datos">
                                            ...
                                            <td style="text-align: left; width: 70%;">
                                                <asp:TextBox ID="txt_Dato" runat="server" ForeColor="Black" Height="18px"
                                                    MaxLength="120"  TabIndex="1" 
