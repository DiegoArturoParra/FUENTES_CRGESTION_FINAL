<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_CartaDetalle, App_Web_5d2q0ozo" stylesheettheme="Standard" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" 
                                                valign="top">
                                                <asp:DropDownList ID="cmb_TipoDocumento" runat="server" TabIndex="6" 
                                                    Width="100%" OnSelectedIndexChanged="cmb_TipoDocumento_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_nombre" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="5000" onkeydown="return SiguienteObjeto()" 
                                        ...
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_descripcion" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="5000" 
                                                    TabIndex="1" Width="100%"  Height="76px" TextMode="MultiLine" 
                                                    onkeydown="contadorTexto(this.form.txt_descripcion, this.form.lblContCaracter, 500);" 
                                                    onkeyup="contadorTexto(this.form.txt_descripcion, this.form.lblContCaracter, 500);" AutoPostBack="True"></asp:TextBox>
                                                <br />
                                                <asp:CustomValidator id="customValidator1" runat="server"
                                                   ControlToValidate="txt_descripcion"
                                                   ErrorMessage="Introduzca 3 caracteres minimo"
                                                   ClientValidationFunction="VerificarCantidad" >
                                                </asp:CustomValidator>
                                                <asp:Label ID="lblContCaracter" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="lbl_FECHAREGISTRA18" runat="server" CssClass="Item" 
                                                    Text="Pie / Asunto:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_pie" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="5000" onkeydown="return SiguienteObjeto()" 
                                                    TabIndex="1" Width="100%" Height="41px" TextMode="MultiLine"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <%--<td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="lbl_FECHAREGISTRA21" runat="server" CssClass="Item" 
                                                    Text="Num_carta:"></asp:Label>
                                            </td>--%>
                                            <%--<td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_Num_carta" runat="server" TabIndex="6" Width="100%">
