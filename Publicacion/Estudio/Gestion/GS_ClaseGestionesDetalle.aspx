<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_ClaseGestionesDetalle, App_Web_hhkm3gt1" stylesheettheme="Standard" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr >
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" 
                                                valign="top">
                                                <asp:DropDownList ID="cmb_CodTipoGestion" runat="server" TabIndex="6" AutoPostBack="True" 
                                                    Width="100%" 
                                        ...
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="lbl_FECHAREGISTRA17" runat="server" CssClass="Item" 
                                                    Text="Descripción:" Visible=false></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_descripcion" runat="server" CssClass="CajaTexto" 
                                                    ...
                                                    TabIndex="1" Width="100%" Visible=false 
                                        ...
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_Resultado" runat="server" AutoPostBack="True" 
                                                    TabIndex="6" Width="100%" 
                                                    onselectedindexchanged="cmb_Resultado_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        <td style="text-align: center">
                            <asp:GridView ID="gv" runat="server" AllowPaging="True" AllowSorting="True" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="CodTipoGestion" HeaderText="Codigo de Ejecutado">
