<%@ page title="" language="C#" masterpagefile="~/Master/Ficha.master" autoeventwireup="true" inherits="Estudio_Gestion_04FrmDatosLaboral, App_Web_hhkm3gt1" stylesheettheme="Standard" %>
                                    ...
                                    <table cellpadding="1" cellspacing="0" border="0" style="width: 100%">
                                        ...
                                        <tr id="FechaIngreso">
                                            ...
                                            <td style="text-align: left; width: 70%;">
                                                ...
                                                <asp:TextBox ID="txt_FechaIngreso" runat="server" Enabled="false" Height="18px" MaxLength="50"
                                                    TabIndex="5" Width="280px"></asp:TextBox>
                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" PopupButtonID="imgCal1"
                                                    TargetControlID="txt_FechaIngreso" Format="dd/MM/yyyy" />
