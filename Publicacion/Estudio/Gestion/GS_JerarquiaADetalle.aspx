<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_JerarquiaADetalle, App_Web_hhkm3gt1" stylesheettheme="Standard" %>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                <asp:Label ID="lbl_FECHAREGISTRA20" runat="server" CssClass="Item" 
                                                    Text="Ejecutores:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_Ejecutores" runat="server" TabIndex="6" Width="100%">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </tbody>
