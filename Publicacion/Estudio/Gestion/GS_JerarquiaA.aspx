<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Gestion_GS_JerarquiaA, App_Web_m4xi2a1f" stylesheettheme="Standard" %>
  ...
  <tr>
    ...
    <td style="height: 28px;">
        <asp:Button ID="btnBuscar" runat="server" OnClick="btnBuscar_Click" 
            onclientclick="Valida_Todos()" TabIndex="1" Text="Buscar" Width="65px" BackColor="000080" ForeColor="White"/>
        <asp:Button ID="btnLimpiar" runat="server" CausesValidation="False" 
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px"  BackColor="000080" ForeColor="White"/>
      </td>
  </tr>
</table>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="desc_ejecutores" HeaderText="Ejecutores" SortExpression="desc_ejecutores">
                                                <ItemStyle Width="50%" HorizontalAlign="Left" VerticalAlign="Middle" Font-Bold="False">
                                                </ItemStyle>
                                                <HeaderStyle Width="50%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>
