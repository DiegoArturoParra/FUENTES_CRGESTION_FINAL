<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_Columna, App_Web_o45h4dkp" stylesheettheme="Standard" %>
            ...
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px" Visible="False"  ForeColor="White" BackColor="#000080"/>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="nIdColumna" HeaderText="IdColumna" InsertVisible="False">
                                            ...
                                            <asp:BoundField DataField="nIdUser" HeaderText="IdUser" Visible="False">
                                                <ItemStyle CssClass="hidden"></ItemStyle>
                                                <HeaderStyle CssClass="hidden"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="cNombreTabla" HeaderText="NombreTabla">
                                                <ItemStyle Width="40%" HorizontalAlign="Left" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="40%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="cNombreColumna" HeaderText="NombreColumna" SortExpression="cNombreColumna">
                                                <ItemStyle Width="10%" HorizontalAlign="Left" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="10%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="cValor" HeaderText="Valor">
                                            </asp:BoundField>
                                                                               
                                            <asp:BoundField DataField="lActivo" HeaderText="Activo" Visible="False" />

                                            <asp:BoundField DataField="lActivoDet" HeaderText="Activo" />
                                            <asp:BoundField DataField="lVisible" HeaderText="lVisible" Visible="False" />
                                            <asp:BoundField DataField="lVisibleDet" HeaderText="Visible" Visible="False" />
                                            <asp:BoundField DataField="nOrden" HeaderText="Orden" Visible="False" />
                                            <asp:BoundField DataField="cDescripcion" HeaderText="Descripcion" Visible="False" />
                                            <asp:BoundField DataField="lModificable" HeaderText="lModificable" Visible="False" />
                                            <asp:BoundField DataField="lModificableDet" HeaderText="Modificable" Visible="False" />
                                            <asp:BoundField DataField="lCampoOrigen" HeaderText="lCampoOrigen" Visible="False" />
                                            <asp:BoundField DataField="lCampoOrigenDet" HeaderText="CampoOrigen" Visible="False" />
                                            <asp:BoundField DataField="cTipoCampo" HeaderText="TipoCampo" Visible="False" />
                                            <asp:BoundField DataField="cTipoDato" HeaderText="lTipoDato" Visible="False" />
                                            <asp:BoundField DataField="cTipoDatoDet" HeaderText="TipoDato" />
                                            <asp:BoundField DataField="nLongDato" HeaderText="LongDato" />
                                            <asp:BoundField DataField="lObligatorio" HeaderText="Obligatorio" Visible="False" />
