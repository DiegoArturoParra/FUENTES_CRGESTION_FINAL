<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_SectoristaDet, App_Web_o45h4dkp" stylesheettheme="Standard" %>
                            ...
                            <td>
                                <table align="center" border="0" cellpadding="4" cellspacing="1" 
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="Gerente">
                                            <td class="labeltextonegro" style=" text-align: left;">
                                                Gerencia&nbsp;
                                            </td>
                                            <td style="text-align: left;">
                                                <asp:DropDownList ID="cmb_Gerencia" runat="server" AutoPostBack="True" TabIndex="1"
                                                Width="90%" onselectedindexchanged="cmb_Gerencia_SelectedIndexChanged" >
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
