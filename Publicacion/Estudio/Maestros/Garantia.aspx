<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_Garantia, App_Web_o45h4dkp" stylesheettheme="Standard" %>
        ...
        <asp:Button ID="btnLimpiar" runat="server" CausesValidation="False" 
            OnClick="btnLimpiar_Click" Text="Limpiar" Width="65px" Visible="False"  ForeColor="White" BackColor="#000080"/>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="CodGarantia" HeaderText="Codigo" SortExpression="CodGarantia">
                                            ...
                                            <asp:BoundField DataField="CodGarantia">
                                                <ItemStyle CssClass="hidden"></ItemStyle>
                                                <HeaderStyle CssClass="hidden"></HeaderStyle>
                                            </asp:BoundField>

                                            <asp:BoundField DataField="Garantia" HeaderText="Descripcion" SortExpression="Garantia">
                                        ...
                                        <SelectedRowStyle CssClass="selectedrow" BackColor="#008A8C" Font-Bold="True" ForeColor="White"></SelectedRowStyle>
