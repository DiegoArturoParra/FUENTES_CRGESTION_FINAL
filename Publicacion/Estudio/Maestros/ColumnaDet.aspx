<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_ColumnaDet, App_Web_o45h4dkp" stylesheettheme="Standard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="DefaultContent" runat="Server">
    <script language="javascript">
        ...
        function ValidaEliminacion() {
            ...
            if (Valida_Texto($get('<%= txcIdColumna.ClientID %>').value) == false) {
                return;
            }
                        ...
                        <tr>
                            <td>
                                <table align="center" border="0" cellpadding="4" cellspacing="1" 
                                    ...
                                    <tbody>
                                        <tr >
                                            <td class="CeldaCabeceraEtiqueta" style="width: 23%; text-align: left; height: 7px; vertical-align:text-top;">
                                                <asp:Label ID="lbl_FECHAREGISTRA16" runat="server" CssClass="labeltextonegro" 
                                                    Text="Código:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left; height: 7px; vertical-align:text-top;">
                                                <asp:TextBox ID="txcIdColumna" runat="server" style="background-color:#cccccc"
                                                    MaxLength="10" onkeydown="return Control_Locked(event);" 
                                                    Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>    
                                        <tr >
                                            <td class="CeldaCabeceraEtiqueta" style="width: 23%; text-align: left; vertical-align:text-top;">
                                                <asp:Label ID="Label2" runat="server" CssClass="labeltextonegro" 
                                                    Text="Nombre de Tabla:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left; vertical-align:text-top;">

                                                <asp:DropDownList ID="cbbNombreTabla" runat="server" AutoPostBack="True" TabIndex="1"
                                                Width="30%" >
                                                </asp:DropDownList>
                                        ...
                                        <tr id="Nombre" >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left; vertical-align:text-top;">
                                                <asp:Label ID="lbl_Nombre" runat="server" CssClass="Item" 
                                                    Text="Nombre de columna:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left; vertical-align:text-top;">
                                                <asp:TextBox ID="txcNombreColumna" runat="server" CssClass="CajaTexto" 
                                        ...
                                        <tr id="CodigoInterno" >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left; vertical-align:text-top;">
                                                <asp:Label ID="Label1" runat="server" CssClass="Item" 
                                                    Text="Valor por defecto:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left; vertical-align:text-top;">
                                                <asp:TextBox ID="txcValorDefecto" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return SiguienteObjeto()" 
                                                    TabIndex="1" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr> 
                                        <tr id="Tr3" >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left; vertical-align:text-top;">
                                                <asp:Label ID="Label5" runat="server" CssClass="Item" 
                                                    Text="Orden:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left; vertical-align:text-top;">
                                                <asp:TextBox ID="txcOrden" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return SiguienteObjeto()" 
                                                    TabIndex="1" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>  
                                        <tr id="Tr1" >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left; vertical-align:text-top;">
                                                <asp:Label ID="Label3" runat="server" CssClass="Item" 
                                                    Text="Descripción:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left; vertical-align:text-top;">
                                                <asp:TextBox ID="txcDescripcion" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return SiguienteObjeto()" 
                                                    TabIndex="1" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="Tr7" >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left; vertical-align:text-top;">
                                                <asp:Label ID="Label9" runat="server" CssClass="Item" 
                                                    Text="Tipo de Dato:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left; vertical-align:text-top;">
                                                <asp:DropDownList ID="cbbTipoDato" runat="server" AutoPostBack="True" TabIndex="1" Width="30%">
                                        ...
                                        <tr id="Tr4" >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left; vertical-align:text-top;">
                                                <asp:Label ID="Label6" runat="server" CssClass="Item" 
                                                    Text="Longitud:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left; vertical-align:text-top;">
                                                <asp:TextBox ID="txnLongitud" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return SiguienteObjeto()" 
                                                    TabIndex="1" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr id="Tr2" >
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left; vertical-align:text-top;">
                                                ...
                                                <asp:CheckBox ID="ckbVisible" runat="server" Text="Visible" />
                                                <asp:CheckBox ID="ckbObligatorio" runat="server" Text="Obligatorio" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
