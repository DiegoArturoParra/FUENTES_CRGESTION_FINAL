<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_CalificacionSBSDet, App_Web_o45h4dkp" stylesheettheme="Standard" %>
                                        ...
                                        <tr id="Inicio" >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" 
                                                ...
                                                <asp:Label ID="Label1" runat="server" CssClass="Item" 
                                                    Text="Inicio Dias Mora:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" 
                                                valign="top">
                                                <asp:TextBox ID="txt_IniDiasMora" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return SiguienteObjeto()" 
                                                    TabIndex="1" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        ...
                                        <tr id="Fin" >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" 
                                                ...
                                                <asp:Label ID="Label2" runat="server" CssClass="Item" 
                                                    Text="Fin dias Mora:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" 
                                                valign="top">
                                                <asp:TextBox ID="txt_FinDiasMora" runat="server" CssClass="CajaTexto" 
                                                    ForeColor="Black" MaxLength="50" onkeydown="return SiguienteObjeto()" 
                                                    TabIndex="1" Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
