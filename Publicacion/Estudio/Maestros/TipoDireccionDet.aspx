<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Estudio_Maestros_TipoDireccionDet, App_Web_o45h4dkp" stylesheettheme="Standard" %>
                                        ...
                                        <tr >
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" 
                                                ...
                                                <asp:Label ID="lbl_Nombre" runat="server" CssClass="Item" 
                                                    Text="Tipo de Contaco:"></asp:Label>
                                            </td>
