<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Mantenimientos_Seguridad_MantModulo, App_Web_nroguq4s" stylesheettheme="Standard" %>
                ...
                ValidationExpression=".{3,}">*</asp:RegularExpressionValidator>
                                    ...
                                    <asp:GridView ID="gv" runat="server" Width="100%" EnableTheming="True" OnSorting="gv_Sorting"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="IdModulo" HeaderText="Codigo" SortExpression="IdModulo">
                                            ...
                                            <asp:BoundField DataField="Descripcion" HeaderText="Descripcion" SortExpression="Descripcion">
                                                <ItemStyle Width="44%" HorizontalAlign="Left" Font-Bold="False"></ItemStyle>
                                                <HeaderStyle Width="44%" CssClass=""></HeaderStyle>
                                            </asp:BoundField>
