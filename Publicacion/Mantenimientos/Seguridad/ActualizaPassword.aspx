<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Mantenimientos_Seguridad_ActualizaPassword, App_Web_nroguq4s" stylesheettheme="Standard" %>
    ...
    <tr>
        ...
        <td style="width: 312px; height: 28px; text-align: left;">
            <asp:Button ID="btnProcesar" runat="server" CausesValidation="False" 
                OnClick="btnProcesar_Click" style="height: 26px" Text="Cambiar" Width="120px"  ForeColor="White" BackColor="#000080"/>
        </td>
        <td style="height: 28px; width: 141px;">
            &nbsp;</td>
        <td style="height: 28px;">
