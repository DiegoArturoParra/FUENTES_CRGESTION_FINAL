<%@ page title="" language="C#" masterpagefile="~/Master/Ceem.master" autoeventwireup="true" inherits="Mantenimientos_Seguridad_MantPerfilDetalle, App_Web_nroguq4s" stylesheettheme="Standard" %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="CeldaCabeceraControl" style="text-align: left; height: 7px;" 
                                            ...
                                            <asp:TextBox ID="txt_IDPERFIL" runat="server" CssClass="CajaTextoDisable" 
                                                style="background-color:#cccccc" MaxLength="10" onkeydown="return Control_Locked(event);" 
                                                Width="99%" ontextchanged="txt_IDPERFIL_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                            <asp:DropDownList ID="cmb_MODULO" runat="server" AutoPostBack="True" 
                                                TabIndex="3" Width="99%">
                                                <asp:ListItem Value="False">HABILITADO</asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                            <asp:TextBox ID="txt_NOMBRE" runat="server" CssClass="CajaTexto" 
                                                ...
                                                TabIndex="1" Width="99%" ontextchanged="txt_NOMBRE_TextChanged"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                            <asp:TextBox ID="txt_DESCRIPCION" runat="server" CssClass="CajaTexto" 
                                                ForeColor="Black" Height="50px" MaxLength="50" TabIndex="2" 
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="" style="text-align: left;" valign="top">
                                                <asp:LinkButton ID="lkb_Perfil" runat="server" BorderWidth="0px" 
                                                    OnClick="lkb_Perfil_Click" SkinID="linkbutton" ViewStateMode="Enabled">&#9658; Asignar Opciones</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
