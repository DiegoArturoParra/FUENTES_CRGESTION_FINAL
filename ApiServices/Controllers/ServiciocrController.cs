...
{
    public class ServiciocrController : ApiController
    {
        // GET api/serviciocr
        [HttpGet]
        ...
        [HttpGet]
        public Response GetImagen(int id)
        {
        ...
        [HttpPost]
        public IEnumerable listpendientes(EnGS_Gestion_Cobranza objEnGS_Gestion_Cobranza)
        {
            ...
            return (from DataRow dr in obj.GS_Gestion_Cobranza_Lista_App(ListEnGS_Gestion_Cobranza).Rows
                    select new
                    {
        ...
        [HttpPost]
        public IEnumerable listEjecutados(EnGS_Gestion_Cobranza objEnGS_Gestion_Cobranza)
        {
        ...
        [HttpPost]
        public IEnumerable listEjecutadosXCliente(EnGS_Gestion_Cobranza objEnGS_Gestion_Cobranza)
        {
        ...
        [HttpPost]
        public IEnumerable traergestor(EnLogin objEnLogin)
        {
            ...
            return (from DataRow dr in objLoLogin.GetUsuarioLogin(ListEnLogin).Rows
                    select new
                    {
        ...
        [HttpPost]
        public IEnumerable listResultadoTodos()
        {
            ...
            return (from DataRow dr in objLoGS_Ejecutado.GS_Ejecutado_TipoGestiones_Combo(ListEnGS_Ejecutado).Rows
                    select new
                    {
        ...
        [HttpPost]
        public IEnumerable listclasificacion(EnGS_Ejecutado objEnGS_Ejecutado)
        {
        ...
        [HttpGet]
        public IEnumerable listresultado(string id)
        {
            ...
            return (from DataRow dr in objLoGS_ClaseGestiones.GS_ClaseGestionesxEjecutado_Combo(ListEnGS_ClaseGestiones).Rows
                    select new
                    {
        ...
        [HttpPost]
        public IEnumerable updategestion(EnGS_Gestion_Cobranza objEnGS_Gestion_Cobranza)
        {
        ...
        [HttpPost]
        public IEnumerable insertgestion(EnGS_Gestion_Cobranza objEnGS_Gestion_Cobranza)
        {
            String lcMensaje = string.Empty;
            List<EnGS_Gestion_Cobranza> ListEnGS_Gestion_Cobranza = new List<EnGS_Gestion_Cobranza>();
            LoGS_Gestion_Cobranza obj = new LoGS_Gestion_Cobranza();
        ...
        [HttpPost]
        public IEnumerable updatedireccion(EnDirecCliente objEnDirecCliente)
        {
        ...
        [HttpPost]
        public IEnumerable testService()
        {
            return "";
        }
        ...
        public IEnumerable Post([FromBody]MyModel myModelObj)
        {
        ...
        // PUT api/serviciocr/5
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/serviciocr/5
