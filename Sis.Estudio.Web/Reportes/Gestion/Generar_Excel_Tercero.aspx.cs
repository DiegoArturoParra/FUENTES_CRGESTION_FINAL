...
public partial class Reportes_Gestion_Generar_Excel_Tercero : System.Web.UI.Page
{
    #region Definiciones
    ...
    private void Exportar()
    {
        ...
        strFichero = "COBRANZA_EXTERNA_" + strFecha + ".xls";
        Response.Clear();
    ...
    private DataSet ReturnDataSet()
    {
        ...
        //int str_Num_carta = int.Parse((String)Request["Num_carta"].ToString().Trim());IdReg_Gestion_Cobranza
        string str_IdReg_Gestion_Cobranza = (String)Request["IdReg_Gestion_Cobranza"].ToString().Trim();
        string str_CEmpresa = (String)Request["cempresa"].ToString().Trim();
        string str_CodUsuario = (String)Request["CodUsuario"].ToString().Trim();
        //int str_Num_carta = int.Parse((String)Request["Num_carta"]);




        objEnGS_Gestion_Cobranza.IdReg_Gestion_Cobranza = str_IdReg_Gestion_Cobranza;
        objEnGS_Gestion_Cobranza.nEmpresa = str_CEmpresa;
