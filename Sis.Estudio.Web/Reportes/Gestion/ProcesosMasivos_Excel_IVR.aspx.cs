...
public partial class Reportes_Gestion_ProcesosMasivos_Excel_IVR : System.Web.UI.Page
{
    #region Definiciones
    ...
    {
        //********************************************************************************
        //** Exportar : Ejecuta la  Exportacón a documento Excel.
        //********************************************************************************
        //export to excel
        ...
        strFichero = "ENVIO_IVR_" + strFecha + ".xls";
        Response.Clear();
