...
public partial class Reportes_Gestion_Generar_Excel_cartas : System.Web.UI.Page
{
    #region Definiciones
    ...
    private void Exportar()
    {
        ...
        //strFichero = dg.Items[0].Cells[2].ToString().Trim() + strFecha + ".xls";
        strFichero = "Action_Plans_Masivos_" + strFecha + ".xls";
        Response.Clear();
        Response.Buffer = true;
        Response.ContentType = "application/vnd.ms-Excel";
        Response.AppendHeader("content-disposition", "inline; filename=" + strFichero);

        this.Session["nombreArchivoExcelGestiones"] = strFichero;
