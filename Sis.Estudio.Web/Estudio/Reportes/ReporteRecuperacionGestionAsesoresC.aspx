<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReporteRecuperacionGestionAsesoresC.aspx.cs" Inherits="Estudio_Reportes_ReporteRecuperacionGestionAsesoresC" %>
...
<asp:BoundColumn DataField="TotRecup" HeaderText="TOTAL"></asp:BoundColumn>
   ...
   <div style="width: 254px">
                <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
                    <Report FileName="ReporteRecuperacionGestionAsesores.rpt">
                    </Report>
