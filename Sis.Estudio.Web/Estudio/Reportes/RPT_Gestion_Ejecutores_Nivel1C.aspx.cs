...
public partial class Estudio_Reportes_RPT_Gestion_Ejecutores_Nivel1C : System.Web.UI.Page
{


    dsGestionEjecutoresNivel1 dsReporte = new dsGestionEjecutoresNivel1();
    rptReporteGestionEjecutoresNivel1 rptReporte = new rptReporteGestionEjecutoresNivel1();
    ...
    private DataSet ReturnDataSet()
    {
        ...
        dt = objLogica.RPT_Gestion_Ejecutores_Nivel1(ListEntidad);

        ds.Tables.Add(dt.Copy());
        ds.Tables[0].TableName = "RPT_Gestion_sp_Ejecutores_Nivel1";
