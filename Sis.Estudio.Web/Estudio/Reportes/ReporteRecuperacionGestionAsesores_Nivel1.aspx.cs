...
public partial class Estudio_Reportes_ReporteRecuperacionGestionAsesores_Nivel1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Reporte De Recuperacion De Gestion de Asesores de Nivel 1";
            #region acces
            //Accesos();
            #endregion accesos
    ...
    private void Exportar(string Formato)
    {
        try
        {
            ...
            sb.Append("<script>var win=window.open('../../Estudio/Reportes/ReporteRecuperacionGestionAsesores_Nivel1C.aspx" + str_Parametros + "', 'ReporteC', " + CONFIG + ");</script>");
