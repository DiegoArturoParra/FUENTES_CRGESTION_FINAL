...
public partial class Estudio_Reportes_ReporteRecuperacionGestionAsesores_Nivel2 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Reporte De Recuperacion De Gestion de Asesores de Nivel 2";
            #region acces
            //Accesos();
            #endregion accesos
    ...
    protected void cmb_Rango_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
         

            int opcion =int.Parse(cmb_Rango.SelectedValue.ToString());
    ...
    //        List<EnGS_TipoGestiones> objListEn = new List<EnGS_TipoGestiones>();
    //        EnGS_TipoGestiones objEn = new EnGS_TipoGestiones();
    //        objEn.NEMPRESA = (String)this.Session[Global.NEmpresa].ToString();
    //        objListEn.Add(objEn);
    //        #endregion Carga_Variable
    //        #region Logica
    //        LoGS_TipoGestiones objLogica = new LoGS_TipoGestiones();
    //        dt = objLogica.RPT_Recuperacion_Ejecutores_Nivel2(objListEn);
    //        #endregion Logica
    //        #region Todos
    ...
    private void Exportar(string Formato)
    {
        try
        {
            ...
            sb.Append("<script>var win=window.open('../../Estudio/Reportes/ReporteRecuperacionGestionAsesores_Nivel2C.aspx" + str_Parametros + "', 'ReporteC', " + CONFIG + ");</script>");
