...
public partial class Estudio_Reportes_RPT_Gestion_Ejecutores_Nivel1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Reporte Gestion Ejecutores Nivel 1";
            #region accesos
            //Accesos();
            #endregion accesos
   ...
   protected void Combo_EstadoGestion()
    ...
    private void Exportar(string Formato)
    {
        try
        {
            ...
            sb.Append("<script>var win=window.open('../../Estudio/Reportes/RPT_Gestion_Ejecutores_Nivel1C.aspx" + str_Parametros + "', 'ReporteC', " + CONFIG + ");</script>");
