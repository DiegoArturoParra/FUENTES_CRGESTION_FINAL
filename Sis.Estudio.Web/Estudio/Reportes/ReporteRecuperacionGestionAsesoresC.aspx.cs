...
public partial class Estudio_Reportes_ReporteRecuperacionGestionAsesoresC : System.Web.UI.Page
{
 
     #region Definiciones
    dsRecuperacionGestionAsesores dsReporte = new dsRecuperacionGestionAsesores();
    rptReporteRecuperacionGestionAsesores rptReporte = new rptReporteRecuperacionGestionAsesores();
    ...
    private DataSet ReturnDataSet()
    {
        ...
        dt = objLogica.RPT_Recuperacion_Ejecutores(ListEntidad);

        ds.Tables.Add(dt.Copy());
        ds.Tables[0].TableName = "RPT_Recuperacion_sp_Ejecutores";
