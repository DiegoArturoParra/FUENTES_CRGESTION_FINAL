<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReporteRecuperacionGestionAsesores_Nivel2C.aspx.cs" Inherits="Estudio_Reportes_ReporteRecuperacionGestionAsesores_Nivel2C" %>
...
<asp:BoundColumn DataField="TotRecup" HeaderText="TOTAL"></asp:BoundColumn>
   ...
   <div style="width: 254px">
                <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
                    <Report FileName="ReporteRecuperacionGestionAsesores_Nivel2.rpt">
                    </Report>
