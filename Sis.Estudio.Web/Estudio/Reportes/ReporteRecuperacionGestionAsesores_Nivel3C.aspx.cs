...
public partial class Estudio_Reportes_ReporteRecuperacionGestionAsesores_Nivel3C : System.Web.UI.Page
{
     #region Definiciones
    dsRecuperacionGestionAsesores_Nivel3 dsReporte = new dsRecuperacionGestionAsesores_Nivel3();
    rptReporteRecuperacionGestionAsesores_Nivel3 rptReporte = new rptReporteRecuperacionGestionAsesores_Nivel3();
    ...
    protected void Page_Load(object sender, EventArgs e)
{
    ...
    private DataSet ReturnDataSet()
    {
        ...
        ds.Tables[0].TableName = "RPT_Recuperacion_sp_Ejecutores_Nivel3";
