<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReporteRecuperacionGestionAsesores_Nivel1C.aspx.cs" Inherits="Estudio_Reportes_ReporteRecuperacionGestionAsesores_Nivel1C" %>
...
<asp:BoundColumn DataField="Nivel2" HeaderText="Nivel2"></asp:BoundColumn>
...
<asp:BoundColumn DataField="TotRecup" HeaderText="TOTAL"></asp:BoundColumn>
   ...
   <div style="width: 254px">
                <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
                    <Report FileName="ReporteRecuperacionGestionAsesores_Nivel1.rpt">
                    </Report>
