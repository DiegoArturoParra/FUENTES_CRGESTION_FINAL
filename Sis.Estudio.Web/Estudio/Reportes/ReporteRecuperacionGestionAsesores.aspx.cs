...
public partial class Estudio_Reportes_ReporteRecuperacionGestionAsesores : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Reporte De Recuperacion Por Gestion De Asesores";
            #region acces
            //Accesos();
            #endregion accesos
    ...
    private void Exportar(string Formato)
    {
        try
        {
            ...
            sb.Append("<script>var win=window.open('../../Estudio/Reportes/ReporteRecuperacionGestionAsesoresC.aspx" + str_Parametros + "', 'ReporteC', " + CONFIG + ");</script>");
