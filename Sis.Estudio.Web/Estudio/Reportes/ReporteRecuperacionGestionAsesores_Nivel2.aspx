<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/Ceem.master" CodeFile="ReporteRecuperacionGestionAsesores_Nivel2.aspx.cs" Inherits="Estudio_Reportes_ReporteRecuperacionGestionAsesores_Nivel2" %>
            ...
            <table id="Botones" border="0" cellpadding="0" cellspacing="0" class="cabeceraScroll"
                ...
                <tr>
                    <td align="left" style="width: 100%;" >
                        <asp:Button ID="btn_Excel" runat="server" BackColor="#808080" BorderStyle="Ridge"
                        ...
                        <asp:Button ID="btn_Imprimir" runat="server" BackColor="#808080" BorderStyle="Ridge"
                            CausesValidation="False" Font-Names="Trebuchet MS" Font-Size="9pt" ForeColor="White"
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 30%; text-align: left;">
                                                    <asp:DropDownList ID="cmb_Anio" runat="server" Font-Size="Small" Height="20px" 
                                                        TabIndex="3" Width="98%" 
                                                        onselectedindexchanged="cmb_Anio_SelectedIndexChanged" AutoPostBack="True">
                                                    </asp:DropDownList>
                                                </td>
                                                <td style="width: 10%; text-align: left;">
                                                </td>
                                                ...
                                                <td style="width: 30%; text-align: left;">
                                                    <asp:DropDownList ID="cmb_Mes" runat="server" Font-Size="Small" TabIndex="3" 
                                                        Width="98%" onselectedindexchanged="cmb_Mes_SelectedIndexChanged" 
                                                        AutoPostBack="True">
                                                            ...
                                                            <tr ID="Rango">
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="cmb_Rango" runat="server" 
                                                                        onselectedindexchanged="cmb_Rango_SelectedIndexChanged" TabIndex="1" 
                                                                        Width="1950%" AutoPostBack="True">
