...
public partial class Estudio_Reportes_RPT_Gestion_Ejecutores_Nivel2C : System.Web.UI.Page
{

    dsGestionEjecutoresNivel2 dsReporte= new dsGestionEjecutoresNivel2();
    rptReporteGestionEjecutoresNivel2 rptReporte = new rptReporteGestionEjecutoresNivel2();
    ...
    private void ResponsePDF()
    {
        ...
        //CrystalReportSource1.ReportDocument.SetParameterValue("nempresa", p1);
        //CrystalReportSource1.ReportDocument.SetParameterValue("codusureg", p2);
        //CrystalReportSource1.ReportDocument.SetParameterValue("sw", p3);
        //CrystalReportSource1.ReportDocument.SetParameterValue("fechaini", p4);
        //CrystalReportSource1.ReportDocument.SetParameterValue("fechafin", p5);
        //CrystalReportSource1.ReportDocument.SetParameterValue("idstgescob", p6);
        //CrystalReportSource1.ReportDocument.SetParameterValue("codtges", p7);
        //CrystalReportSource1.ReportDocument.SetParameterValue("anio", p8);
        //CrystalReportSource1.ReportDocument.SetParameterValue("mes", p9);
    ...
    private DataSet ReturnDataSet()
    {
        ...
        dt = objLogica.RPT_Gestion_Ejecutores_Nivel2(ListEntidad);

        ds.Tables.Add(dt.Copy());
        ds.Tables[0].TableName = "RPT_Gestion_sp_Ejecutores_Nivel2";
