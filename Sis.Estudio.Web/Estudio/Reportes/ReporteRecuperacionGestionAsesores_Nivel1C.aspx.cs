...
public partial class Estudio_Reportes_ReporteRecuperacionGestionAsesores_Nivel1C : System.Web.UI.Page
{
    #region Definiciones
    dsRecuperacionGestionAsesores_Nivel1 dsReporte = new dsRecuperacionGestionAsesores_Nivel1();
    rptReporteRecuperacionGestionAsesores_Nivel1 rptReporte = new rptReporteRecuperacionGestionAsesores_Nivel1();
    ...
    private DataSet ReturnDataSet()
    {
        ...
        dt = objLogica.RPT_Recuperacion_Ejecutores_Nivel1(ListEntidad);

        ds.Tables.Add(dt.Copy());
        ds.Tables[0].TableName = "RPT_Recuperacion_sp_Ejecutores_Nivel1";
