<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RPT_Gestion_Ejecutores_Nivel3C.aspx.cs" Inherits="Estudio_Reportes_RPT_Gestion_Ejecutores_Nivel3C" %>
    ...
    <form id="form1" runat="server">
      ...
      <div style="width: 254px">
                <cr:crystalreportsource ID="CrystalReportSource1" runat="server">
                    <Report FileName="RPT_Gestion_Ejecutores_Nivel3.rpt">
                    </Report>
