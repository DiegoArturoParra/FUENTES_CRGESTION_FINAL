...
public partial class Estudio_Maestros_Producto : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "ProductoDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Producto";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.Producto_Listar(ListE);
