...
public partial class Estudio_Maestros_TipoDireccionDet : BaseMantDetalle
{

    #region Declaraciones
    private const string PaginaRetorno = "TipoDireccion.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.TipoDireccion;
            this.Master.TituloModulo = "Detalle de Tipo Contacto";
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            List<EnTipoDireccion> objListEn = new List<EnTipoDireccion>();
            EnTipoDireccion objEn = new EnTipoDireccion();

            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodTipoDir = str_ID;
            ...
            dt = objLo.TipoDireccion_Listar_Reg(objListEn);
            if (dt.Rows.Count > 0)
            {
                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodTipoDir"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["TipoDireccion"].ToString();
    ...
    private bool Valida_Datos()
    {
        ...
        if (txt_NOMBRE.Text == "")
        {
            MostrarMensaje("Ingrese Tipo Dirección.", true);
            Cursor_Control(txt_NOMBRE);
            return false;
        }
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodTipoDireccion = Util.FormateaEntero(txt_ID.Text);
            objEn.TipoDireccion = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.TipoDireccion_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoTipoDireccion ObjLo = new LoTipoDireccion();
            msg = ObjLo.TipoDireccion_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
