...
public partial class Estudio_Maestros_SubProducto : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "SubProductoDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Sub Producto";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.SubProducto_Listar(ListEn);
