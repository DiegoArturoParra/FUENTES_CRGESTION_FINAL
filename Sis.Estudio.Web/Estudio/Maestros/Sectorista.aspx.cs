...
public partial class Estudio_Maestros_Sectorista : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "SectoristaDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Sectorista";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.Sectorista_Listar(ListEnSectorista);
