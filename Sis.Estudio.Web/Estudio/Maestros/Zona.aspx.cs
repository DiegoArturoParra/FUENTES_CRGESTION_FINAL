...
public partial class Estudio_Maestros_Zona : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "ZonaDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Zona";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.Zona_Listar(ListEn);
