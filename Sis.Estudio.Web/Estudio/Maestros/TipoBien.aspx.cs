...
public partial class Estudio_Maestros_TipoBien : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "TipoBienDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Tipo Bien";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.TipoBien_Listar();
