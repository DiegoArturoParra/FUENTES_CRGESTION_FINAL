...
public partial class Estudio_Maestros_Gerencia : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "GerenciaDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Gerencia";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.Gerencia_Listar(ListEn);
