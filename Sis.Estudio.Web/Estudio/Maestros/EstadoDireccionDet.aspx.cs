...
public partial class Estudio_Maestros_EstadoDireccionDet : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "EstadoDireccion.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.EstadoDireccion;
            this.Master.TituloModulo = "Detalle de Estado Dirección";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            List<EnEstadoDireccion> objListEn = new List<EnEstadoDireccion>();
            EnEstadoDireccion objEn = new EnEstadoDireccion();

            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodEstadoDir = str_ID;
            ...
            dt = objLo.EstadoDireccion_Listar_Reg(objListEn);
            if (dt.Rows.Count > 0)
            {
                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodEstadoDir"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["Descrip"].ToString();                
    ...
    private bool Valida_Datos()
    {
        ...
        if (txt_NOMBRE.Text == "")
        {
            MostrarMensaje("Ingrese Estado Dirección.", true);
            Cursor_Control(txt_NOMBRE);
            return false;
        }
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodEstadoDir = Util.FormateaEntero(txt_ID.Text);
            objEn.Descrip = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.EstadoDireccion_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoEstadoDireccion ObjLo = new LoEstadoDireccion();
            msg = ObjLo.EstadoDireccion_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
