...
public partial class Estudio_Maestros_ProductoDet : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "Producto.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.Producto;
            this.Master.TituloModulo = "Detalle de Producto";
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            dt = objLo.Producto_Listar_Reg(objListEn);
            if (dt.Rows.Count > 0)
            {
                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodProducto"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["Producto"].ToString();
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodProducto = Util.FormateaEntero(txt_ID.Text);
            objEn.Producto = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.Producto_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoProducto ObjLo = new LoProducto();
            msg = ObjLo.Producto_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
