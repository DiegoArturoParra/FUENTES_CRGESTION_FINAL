...
public partial class Estudio_Maestros_TipoContactoDet : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "TipoContacto.aspx";
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            List<EnTipoContacto> objListEn = new List<EnTipoContacto>();
            EnTipoContacto objEn = new EnTipoContacto();

            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodTipoContacto = str_ID;
            ...
            dt = objLo.TipoContacto_Listar_Reg(objListEn);
            if (dt.Rows.Count > 0)
            {
                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodTipoContacto"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["TipoContacto"].ToString();
    ...
    private bool Valida_Datos()
    {
        ...
        if (txt_NOMBRE.Text == "")
        {
            MostrarMensaje("Ingrese Tipo Contacto.", true);
            Cursor_Control(txt_NOMBRE);
            return false;
        }
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodTipoContacto = Util.FormateaEntero(txt_ID.Text);
            objEn.TipoContacto = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.TipoContacto_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoTipoContacto ObjLo = new LoTipoContacto();
            msg = ObjLo.TipoContacto_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
