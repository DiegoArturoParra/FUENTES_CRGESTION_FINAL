...
public partial class Estudio_Maestros_Sucursal : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "SucursalDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Sucursal";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.Sucursal_Listar(ListEnSucursal);
