...
public partial class Estudio_Maestros_Garantia : BaseMantListado
{
    #region Declaraciones
    
    private string PaginaDetalle = "GarantiaDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Garantia";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.Garantia_Listar(ListEn);
