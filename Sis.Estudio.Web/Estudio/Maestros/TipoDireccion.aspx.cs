...
public partial class Estudio_Maestros_TipoDireccion : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "TipoDireccionDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Tipo Dirección";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.TipoDireccion_Listar();
