...
public partial class Estudio_Maestros_SituacionLaboralDet : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "SituacionLaboral.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.SituacionLaboral;
            this.Master.TituloModulo = "Detalle de Situación Laboral";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            List<EnSituacionLaboral> objListEn = new List<EnSituacionLaboral>();
            EnSituacionLaboral objEn = new EnSituacionLaboral();

            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodSitLab = str_ID;
            ...
            dt = objLo.SituacionLaboral_Listar_Reg(objListEn);
            if (dt.Rows.Count > 0)
            {
                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodSitLab"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["SitLab"].ToString();
    ...
    private bool Valida_Datos()
    {
        ...
        if (txt_NOMBRE.Text == "")
        {
            MostrarMensaje("Ingrese SituacionLaboral.", true);
            Cursor_Control(txt_NOMBRE);
            return false;
        }
        #endregion para_Todo
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodSitLab = Util.FormateaEntero(txt_ID.Text);
            objEn.SitLab = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.SituacionLaboral_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoSituacionLaboral ObjLo = new LoSituacionLaboral();
            msg = ObjLo.SituacionLaboral_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
