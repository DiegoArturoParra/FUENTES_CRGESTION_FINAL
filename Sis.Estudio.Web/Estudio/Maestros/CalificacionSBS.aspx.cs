...
public partial class Estudio_Maestros_CalificacionSBS : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "CalificacionSBSDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Calificacion SBS";
    ...
    protected override void Obtener_Datos()
    {
        ...
        {            
            ...
            DT_Datos = objLo.CalificacionSBS_Listar();
