...
public partial class Estudio_Maestros_Columna : BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "ColumnaDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Columnas de Trabajo";
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = loLoColumna.mxColumnaTrabajo_Listar(lstEnColumna);
        }
        catch (Exception ex)
        {
            throw ex;
