...
public partial class Estudio_Maestros_SituacionLaboral : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "SituacionLaboralDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Situación Laboral";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {
            ...
            DT_Datos = objLo.SituacionLaboral_Listar();
