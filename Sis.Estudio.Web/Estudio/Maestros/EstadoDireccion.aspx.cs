...
public partial class Estudio_Maestros_EstadoDireccion : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "EstadoDireccionDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Estado Dirección";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        try
        {           
            DT_Datos = objLo.EstadoDireccion_Listar();
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnAccion.Id = gv.SelectedRow.Cells[1].Text.ToString();
