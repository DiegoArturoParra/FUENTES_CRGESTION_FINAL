...
public partial class Estudio_Maestros_SucursalDet : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "Sucursal.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.Sucursal;
            this.Master.TituloModulo = "Detalle de Sucursal";
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            dt = objLo.Sucursal_Listar_Reg(objListEn);

            if (dt.Rows.Count > 0)
            {

                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodSucursal"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["Sucursal"].ToString();
    ...
    private bool Valida_Datos()
    {
        ...
        if (txt_NOMBRE.Text == "")
        {
            MostrarMensaje("Ingrese Sucursal.", true);
            Cursor_Control(txt_NOMBRE);
            return false;
        }
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodSucursal = Util.FormateaEntero(txt_ID.Text);
            objEn.Sucursal = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.Sucursal_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoSucursal ObjLo = new LoSucursal();
            msg = ObjLo.Sucursal_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
