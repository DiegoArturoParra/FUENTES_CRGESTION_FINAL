...
public partial class Estudio_Maestros_GarantiaDet : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "Garantia.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.Garantia;
            this.Master.TituloModulo = "Detalle de Garantia";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            dt = objLo.Garantia_Listar_Reg(objListEn);
            if (dt.Rows.Count > 0)
            {
                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodGarantia"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["Garantia"].ToString();
    ...
    private bool Valida_Datos()
    {
        ...
        if (txt_NOMBRE.Text == "")
        {
            MostrarMensaje("Ingrese Garantia.", true);
            Cursor_Control(txt_NOMBRE);
            return false;
        }
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodGarantia = Util.FormateaEntero(txt_ID.Text);
            objEn.Garantia = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.Garantia_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoGarantia ObjLo = new LoGarantia();
            msg = ObjLo.Garantia_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
