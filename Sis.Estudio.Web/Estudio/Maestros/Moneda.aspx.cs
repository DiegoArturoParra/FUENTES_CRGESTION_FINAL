...
public partial class Estudio_Maestros_Moneda :  BaseMantListado
{
    #region Declaraciones

    private string PaginaDetalle = "MonedaDet.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Moneda";
          #region accesos
            Accesos();
            #endregion accesos
 ...
 
    {
        ...
        objEn.DesMoneda = Util.FormateaTexto(txt_descripcion.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLo.Moneda_Listar(ListEnMoneda);
    ...
    private void Exportar(string Formato) 
  {
    ...
    private void Anular(){
        ...
        try
        {
                ...
                //objEn.CodEmpMoneda = (int)this.Session["CodEmpMoneda"];

              
                objEn.CodMoneda = int.Parse(gv.SelectedRow.Cells[1].Text);
