...
public partial class Estudio_Maestros_GerenciaDet : BaseMantDetalle
{

    #region Declaraciones
    private const string PaginaRetorno = "Gerencia.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.Gerencia;
            this.Master.TituloModulo = "Detalle de Gerencia";
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            dt = objLo.Gerencia_Listar_Reg(objListEn);

            if (dt.Rows.Count > 0)
            {

                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodGerencia"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["Gerencia"].ToString();
    ...
    private bool Valida_Datos()
    {
        ...
        if (txt_NOMBRE.Text == "")
        {
            MostrarMensaje("Ingrese Gerencia", true);
            Cursor_Control(txt_NOMBRE);
            return false;
        }
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodGerencia = Util.FormateaEntero(txt_ID.Text);
            objEn.Gerencia = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.Gerencia_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoGerencia ObjLo = new LoGerencia();
            msg = ObjLo.Gerencia_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
