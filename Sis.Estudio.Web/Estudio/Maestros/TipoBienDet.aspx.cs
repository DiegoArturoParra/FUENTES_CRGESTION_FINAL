...
public partial class Estudio_Maestros_TipoBienDet : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "TipoBien.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.TipoBien;
            this.Master.TituloModulo = "Detalle de Tipo Bien";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            List<EnTipoBien> objListEn = new List<EnTipoBien>();
            EnTipoBien objEn = new EnTipoBien();

            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodTipoBien = str_ID;
            ...
            dt = objLo.TipoBien_Listar_Reg(objListEn);
            if (dt.Rows.Count > 0)
            {
                #region CONTROLES_MANTENIMIENTO
                txt_ID.Text = dt.Rows[0]["CodTipoBien"].ToString();
                txt_NOMBRE.Text = dt.Rows[0]["TipoBien"].ToString();
    ...
    private bool Valida_Datos()
    {
        ...
        if (txt_NOMBRE.Text == "")
        {
            MostrarMensaje("Ingrese TipoBien.", true);
            Cursor_Control(txt_NOMBRE);
            return false;
        }
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEn.NEmpresa = (String)this.Session[Global.NEmpresa].ToString();
            objEn.CodTipoBien = Util.FormateaEntero(txt_ID.Text);
            objEn.TipoBien = txt_NOMBRE.Text;
            ...
            List<EnTransaccion> RetornoT = ObjLo.TipoBien_INS(objListEn);
    ...
    private void Modificar()
    {
        try
        {
            ...
            #endregion Carga_Variable
            LoTipoBien ObjLo = new LoTipoBien();
            msg = ObjLo.TipoBien_UPD(objListEn);
            if (msg == "exito")
            {
                metodo_Consulta();
