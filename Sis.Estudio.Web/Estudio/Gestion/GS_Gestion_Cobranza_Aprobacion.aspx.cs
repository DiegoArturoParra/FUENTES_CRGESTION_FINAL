...
public partial class Estudio_Gestion_GS_Gestion_Cobranza_Aprobacion : System.Web.UI.Page
{
    #region Declaraciones
    private string PaginaDetalle = "GS_Gestion_Cobranza_Detalle_Aprobacion.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Gestion de Cobranzas";
            ...
            btnAprobar.Attributes.Add("onClick", "document.getElementById('hdnContinuar').value = confirm('Se aprobará todos los registros seleccionados, ¿Desea continuar?');");
            btnRechazar.Attributes.Add("onClick", "document.getElementById('hdnContinuar').value = confirm('Se rechazará todos los registros seleccionados, ¿Desea continuar?');");
    ...
    */
    ...
    private void RefrescarGrid()
    {
        ...
        try
        {
            DT_Datos = objLoGS_Gestion_Cobranza.GS_Gestion_Cobranza_Lista_Aprobaciones(ListEnGS_Gestion_Cobranza);
                ...
                foreach (GridViewRow row in gv.Rows)
                {
                    ...
                    if (((CheckBox)row.FindControl("chkPermiso")).Checked == true)
                    {
                        ...
                        try
                        {
                            ...
                            /**Acelerar Tramo**/
                            //objLoGS_Gestion_Cobranza.GS_ClientePRODCronograma_sp_Modificar_FechaVencimientoReal(ListEnGS_Gestion_Cobranza);
                            /**Fin Acelerar Tramo**/
