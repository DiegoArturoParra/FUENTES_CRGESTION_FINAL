<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Ceem.master" AutoEventWireup="true" CodeFile="GS_Gestion_CarteraCobranzaDetalle.aspx.cs" Inherits="Estudio_Gestion_GS_Gestion_CarteraCobranzaDetalle" %>
                                    ...
                                    <tbody>
                                        <tr >
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left; height: 7px;" 
                                                valign="top">
                                                <asp:TextBox ID="txt_codigo" runat="server" MaxLength="10" 
                                        ...
                                        <tr>
                                            ...
                                            <td class="CeldaCabeceraControl" style="text-align: left; height: 7px;" 
                                                valign="top">
                                                <asp:TextBox ID="txt_FechaRegistra" runat="server" MaxLength="10" 
                                                    onkeydown="return Control_Locked(event);" style="background-color: #E8E8E8" 
                                                    Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top" 
                                                bgcolor="#CCCCCC">
                                                <asp:Label ID="lbl_FECHAREGISTRA25" runat="server" CssClass="Item" 
                                                    Text="Dias de Control:"></asp:Label>
                                            </td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:TextBox ID="txt_dias_control" runat="server" MaxLength="10" 
                                                    onkeydown="return Control_Locked(event);" style="background-color:#E8E8E8" 
                                                    Width="100%"></asp:TextBox>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="labeltextonegro" style="width: 23%; text-align: left;" valign="top">
                                                Resultado:</td>
                                            <td class="CeldaCabeceraControl" style="text-align: left;" valign="top">
                                                <asp:DropDownList ID="cmb_ClaseGestiones" runat="server" TabIndex="6" 
                                                    Width="100%"  AutoPostBack="True" 
                                                    onselectedindexchanged="cmb_ClaseGestiones_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
