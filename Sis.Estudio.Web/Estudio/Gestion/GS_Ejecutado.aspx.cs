...
public partial class Estudio_Gestion_GS_Ejecutado : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "GS_EjecutadoDetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Clasificaciones del Action Plan";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        objEnGS_Ejecutado.nempresa = (String)this.Session["cempresa"];
        objEnGS_Ejecutado.Descripcion = Util.FormateaTexto(txt_DESCRIPCION.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLoGS_Ejecutado.GS_Ejecutado_Lista(ListEnGS_Ejecutado);
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnGS_Ejecutado.CodEjecutado = gv.SelectedRow.Cells[1].Text.ToString();
