...
public partial class Estudio_Gestion_GS_JerarquiaD : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "GS_JerarquiaDDetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            G_idopcion = OpcionModulo.MantJerarquiaD;
            this.Master.TituloModulo = "Mantenimiento de Jerarquia Nivel D";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        objEnGS_JerarquiaD.desc_jerarquiaD = Util.FormateaTexto(txt_DESCRIPCION.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLoGS_JerarquiaD.GS_JerarquiaD_Lista(ListEnGS_JerarquiaD);
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnGS_JerarquiaD.cod_jerarquiaD = gv.SelectedRow.Cells[1].Text.ToString();
