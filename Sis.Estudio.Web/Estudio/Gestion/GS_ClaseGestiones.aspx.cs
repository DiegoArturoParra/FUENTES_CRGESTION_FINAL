...
public partial class Estudio_Gestion_GS_ClaseGestiones : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "GS_ClaseGestionesDetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Resultados por Clasificaciones de Action Plans";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        objEnGS_ClaseGestiones.nempresa = (String)this.Session["cempresa"];
        objEnGS_ClaseGestiones.Descripcion = Util.FormateaTexto(txt_DESCRIPCION.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLoGS_ClaseGestiones.GS_ClaseGestiones_Lista(ListEnGS_ClaseGestiones);
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnGS_ClaseGestiones.CodClaseGestion = gv.SelectedRow.Cells[1].Text.ToString();
