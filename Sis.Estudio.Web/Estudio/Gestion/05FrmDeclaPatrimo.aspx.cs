...
public partial class Estudio_Gestion_05FrmDeclaPatrimo : System.Web.UI.Page
{
    ...
    {
        #region Redim
        string idifame = AcetPanel.DeclaPatrimo.iframe_id;
        #region ResizeFicha
    ...
    protected void Combo_TipoBien()
    {
        ...
        try
        {
            ...
            LoDeclaPatrimo objLo = new LoDeclaPatrimo();
            dt = objLo.DeclaPatrimo_TipoBien_Lista();
    ...
    private void Listar()
    {
        ...
        try
        {
            ...
            List<EnDeclaPatrimo> ListEnDeclaPatrimo = new List<EnDeclaPatrimo>();
            EnDeclaPatrimo objEnDeclaPatrimo = new EnDeclaPatrimo();
            objEnDeclaPatrimo.nempresa = (String)this.Session[Global.NEmpresa].ToString();
            objEnDeclaPatrimo.CodigoCliente = (String)this.Session[Global.CodCliente].ToString();
            ListEnDeclaPatrimo.Add(objEnDeclaPatrimo);
            #endregion Carga_Variable
            LoDeclaPatrimo objLo = new LoDeclaPatrimo();

            dt = objLo.DeclaPatrimo_Lista(ListEnDeclaPatrimo);
    ...
    protected void MostrarDatos(string str_Codigo)
    {
        ...
        try
        {
            ...
            EnDeclaPatrimo objEnDeclaPatrimo = new EnDeclaPatrimo();
            objEnDeclaPatrimo.nempresa = (String)this.Session[Global.NEmpresa].ToString();
            objEnDeclaPatrimo.IdReg = str_Codigo;
            objEnDeclaPatrimo.CodUsuario = (String)this.Session[Global.CodUsuario].ToString(); ;
            ListEnDeclaPatrimo.Add(objEnDeclaPatrimo);
            #endregion Carga_Variable
            LoDeclaPatrimo objLo = new LoDeclaPatrimo();

            dt = objLo.DeclaPatrimo_Lista_Reg(ListEnDeclaPatrimo);
    ...
    private void Graba()
    {
        try
        {
            ...
            objEnDeclaPatrimo.CodTipoBien = cmb_TipoBien.SelectedValue.Trim();
            objEnDeclaPatrimo.PorPropiedad = Util.FormateaDecimal(txt_PorPropiedad.Text);
            objEnDeclaPatrimo.ValorComercial = Util.FormateaDecimal(txt_ValorComercial.Text);
            objEnDeclaPatrimo.Moneda = Util.FormateaEntero(txt_Moneda.Text);
            objEnDeclaPatrimo.PartidaRegistral = txt_PartidaRegistral.Text.Trim();
            objEnDeclaPatrimo.DatosBien = txt_DatosBien.Text.Trim();

            objEnDeclaPatrimo.Observacion = txt_Observacion.Text.Trim();
            objEnDeclaPatrimo.Estado = cmb_Estado.SelectedValue.Trim();
            objEnDeclaPatrimo.CodUsuario = (String)this.Session[Global.CodUsuario].ToString();
            ...
            LoDeclaPatrimo objLo = new LoDeclaPatrimo();
            msg = objLo.DeclaPatrimo_INS(ListEnDeclaPatrimo);
    ...
    private void Modifica()
    {
        try
        {
            ...
            List<EnDeclaPatrimo> ListEnDeclaPatrimo = new List<EnDeclaPatrimo>();
            EnDeclaPatrimo objEnDeclaPatrimo = new EnDeclaPatrimo();
            objEnDeclaPatrimo.IdReg = hd_Codigo.Value.Trim();
            objEnDeclaPatrimo.nempresa = (String)this.Session[Global.NEmpresa].ToString();
            objEnDeclaPatrimo.CodigoCliente = (String)this.Session[Global.CodCliente].ToString();
            ...
            #endregion Carga_Variable
            LoDeclaPatrimo objLo = new LoDeclaPatrimo();
            msg = objLo.DeclaPatrimo_UPD(ListEnDeclaPatrimo);
            if (msg == "exito")
            {
                Master.MostrarMensaje(Mensaje.M_OPERACION_SATISFACTORIA, TipoMensaje.Exito);
                Listar();
