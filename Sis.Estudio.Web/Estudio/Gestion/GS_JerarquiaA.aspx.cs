...
public partial class Estudio_Gestion_GS_JerarquiaA : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "GS_JerarquiaADetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Jerarquia Nivel A";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        objEnGS_JerarquiaA.desc_jerarquiaA = Util.FormateaTexto(txt_DESCRIPCION.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLoGS_JerarquiaA.GS_JerarquiaA_Lista(ListEnGS_JerarquiaA);
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnGS_JerarquiaA.cod_jerarquiaA = gv.SelectedRow.Cells[1].Text.ToString();
