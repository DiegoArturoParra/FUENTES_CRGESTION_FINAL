...
public partial class Estudio_Gestion_GS_TipoGestiones : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "GS_TipoGestionesDetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Configurar Action Plan";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    */
    ...
    protected override void Obtener_Datos()
    {
        ...
        objEnGS_TipoGestiones.Descripcion = Util.FormateaTexto(txt_DESCRIPCION.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLoGS_TipoGestiones.GS_TipoGestiones_Lista(ListEnGS_TipoGestiones);
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnGS_TipoGestiones.CodTipoGestion = gv.SelectedRow.Cells[1].Text.ToString();
