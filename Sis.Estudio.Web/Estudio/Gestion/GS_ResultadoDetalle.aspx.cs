...
public partial class Estudio_Gestion_GS_ResultadoDetalle : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "GS_Resultado.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            G_idopcion = OpcionModulo.MantResultadoClasificacion;
            this.Master.TituloModulo = "Detalle de Resultado de Clasificación";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            EnGS_Resultado ObjEnGS_Resultado = new EnGS_Resultado();
            List<EnGS_Resultado> ListEnGS_Resultado = new List<EnGS_Resultado>();

            ObjEnGS_Resultado.CodResultado =str_ID;
            ListEnGS_Resultado.Add(ObjEnGS_Resultado);
            dt = ObjLoGS_Resultado.GS_Resultado_Reg(ListEnGS_Resultado);
            if (dt.Rows.Count > 0)
            {
                #region CONTROLES_MANTENIMIENTO
                txt_codigo.Text = dt.Rows[0]["CodResultado"].ToString();
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            ObjEnGS_Resultado.Descripcion = txt_descripcion.Text.Trim();

            ObjEnGS_Resultado.CodUsuario = (String)this.Session["codusuario"];

            ListEnGS_Resultado.Add(ObjEnGS_Resultado);
            #endregion Cargar_Variables
            List<EnTransaccion> RetornoT = ObjLoGS_Resultado.GS_Resultado_INS(ListEnGS_Resultado);
    ...
    private void Modificar()
    {
        ...
        try
        {
            ...
            ObjEnGS_Resultado.CodResultado = txt_codigo.Text.Trim();
            ObjEnGS_Resultado.Descripcion = txt_descripcion.Text.Trim();
            ...
            ListEnGS_Resultado.Add(ObjEnGS_Resultado);
            #endregion Cargar_Variables                       
            msg = ObjLoGS_Resultado.GS_Resultado_UPD(ListEnGS_Resultado);
            if (msg == "exito") { Exito = FlagsPrograma.FLG_VALOREXITOSI; } else { Master.MostrarMensaje(msg, TipoMensaje.Error, msg); Exito = FlagsPrograma.FLG_VALOREXITONO; return; }
        }
        catch (SqlException ex)
        {
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            msg = ObjLoGS_Resultado.GS_Resultado_DEL(ListEnGS_Resultado);
