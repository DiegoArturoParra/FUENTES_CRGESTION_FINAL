...
public partial class Estudio_Gestion_GS_Gestion_Cobranza_Carta_MasivaDetalle : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "GS_Gestion_Cobranza_Carta_Masiva.aspx";
