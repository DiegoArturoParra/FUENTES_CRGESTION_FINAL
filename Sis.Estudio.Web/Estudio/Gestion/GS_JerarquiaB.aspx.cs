...
public partial class Estudio_Gestion_GS_JerarquiaB : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "GS_JerarquiaBDetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Jerarquia Nivel B";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        objEnGS_JerarquiaB.desc_jerarquiaB = Util.FormateaTexto(txt_DESCRIPCION.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLoGS_JerarquiaB.GS_JerarquiaB_Lista(ListEnGS_JerarquiaB);
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnGS_JerarquiaB.cod_jerarquiaB = gv.SelectedRow.Cells[1].Text.ToString();
