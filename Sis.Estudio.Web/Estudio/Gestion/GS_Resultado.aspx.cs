...
public partial class Estudio_Gestion_GS_Resultado : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "GS_ResultadoDetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Resultado de Clasificación";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        objEnGS_Resultado.nempresa = (String)this.Session["cempresa"];
        objEnGS_Resultado.Descripcion = Util.FormateaTexto(txt_DESCRIPCION.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLoGS_Resultado.GS_Resultado_Lista(ListEnGS_Resultado);
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnGS_Resultado.CodResultado = gv.SelectedRow.Cells[1].Text.ToString();
