...
public partial class Estudio_Gestion_GS_JerarquiaCDetalle : BaseMantDetalle
{
    #region Declaraciones
    private const string PaginaRetorno = "GS_JerarquiaC.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Detalle de Jerarquia Nivel C";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected void MostrarDatos(string str_TIPO, string str_ID)
    {
        ...
        try
        {
            ...
            ObjEnGS_JerarquiaC.cod_jerarquiaC = str_ID;
            ListEnGS_JerarquiaC.Add(ObjEnGS_JerarquiaC);
            dt = ObjLoGS_JerarquiaC.GS_JerarquiaC_Reg(ListEnGS_JerarquiaC);
            if (dt.Rows.Count > 0)
            {
                ...
                txt_codigo.Text = dt.Rows[0]["cod_jerarquiaC"].ToString();
                ...
                txt_descripcion.Text = dt.Rows[0]["desc_jerarquiaC"].ToString();
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            ObjEnGS_JerarquiaC.cod_jerarquiaA = cmb_JerarquiaA.SelectedValue.ToString();
            ObjEnGS_JerarquiaC.cod_jerarquiaB = cmb_JerarquiaB.SelectedValue.ToString();

            ObjEnGS_JerarquiaC.desc_jerarquiaC = txt_descripcion.Text.Trim();
            ...
            List<EnTransaccion> RetornoT = ObjLoGS_JerarquiaC.GS_JerarquiaC_INS(ListEnGS_JerarquiaC);
    ...
    private void Modificar()
    {
        ...
        try
        {
            ...
            ListEnGS_JerarquiaC.Add(ObjEnGS_JerarquiaC);
            #endregion Cargar_Variables                       
            msg = ObjLoGS_JerarquiaC.GS_JerarquiaC_UPD(ListEnGS_JerarquiaC);
            if (msg == "exito") { Exito = FlagsPrograma.FLG_VALOREXITOSI; } else { Master.MostrarMensaje(msg, TipoMensaje.Error, msg); Exito = FlagsPrograma.FLG_VALOREXITONO; return; }
        }
        catch (SqlException ex)
        {
