...
public partial class Mantenimientos_Seguridad_MantModulo : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "MantModuloDetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            this.Master.TituloModulo = "Mantenimiento de Modulos";
            #region accesos
            Accesos();
            #endregion accesos
    ...
    protected override void Obtener_Datos()
    {
        ...
        objEnModulo.Accion = G_Accion.ToString();
        objEnModulo.CEmpresa =(String)this.Session["cempresa"];
        objEnModulo.Nombre = Util.FormateaTexto(txt_NOMBRE.Text.Trim());
        objEnModulo.Descripcion = Util.FormateaTexto(txt_DESCRIPCION.Text.Trim());
        ...
        try
        {
            ...
            DT_Datos = objLomodulo.Listado_Modulo(ListEnModulo);
    ...
    private void Anular()
    {
        ...
        try
        {
            ...
            ObjEnModulo.Id = gv.SelectedRow.Cells[1].Text.ToString();
            ObjEnModulo.CEmpresa = (String)this.Session["cempresa"];
