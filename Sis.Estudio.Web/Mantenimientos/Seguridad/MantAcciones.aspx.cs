...
public partial class Mantenimientos_Seguridad_MantAcciones : BaseMantListado
{
    #region Declaraciones
    private string PaginaDetalle = "MantAccionesDetalle.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            G_idopcion =  OpcionModulo.MantAccion;
            this.Master.TituloModulo = "Mantenimiento de Funciones";
            #region accesos
            Accesos();
            #endregion accesos
