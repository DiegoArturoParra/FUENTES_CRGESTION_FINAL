...
public partial class Mantenimientos_Seguridad_MantOpcionDetalle : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Master.TituloModulo = "Detalle Menu";
            InicioOperacion();
        }
    }
    ...
    private void Grabar()
    {
        ...
        try
        {
            ...
            objEnOpcion.Descripcion = txt_DESCRIPCION.Text.Trim();
            ...
            msg = objLoOpcion.Insertar_OpcionMenu(ListEnOpcion);
            
            if (msg == "") { Exito = FlagsPrograma.FLG_VALOREXITOSI; } else { Master.MostrarMensaje(msg, TipoMensaje.Error); Exito = FlagsPrograma.FLG_VALOREXITONO; return; }
    ...
    private void Modificar()
    {
        ...
        try
        {
            ...
            msg = objLoOpcion.Modifica_OpcionMenu(ListEnOpcion);
