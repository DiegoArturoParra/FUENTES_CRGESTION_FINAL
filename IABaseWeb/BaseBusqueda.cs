...
namespace IABaseWeb
{
    public partial class BaseBusqueda : BaseWeb
    {
        ...
        protected virtual bool Obtener_Datos()
        {
            return true;
        }
        #endregion Funciones        
        ...
        private void AddRowSelectToGridView(GridView gv)
        {
            ...
            if (gv.EditIndex == -1)
            {
                foreach (GridViewRow row in gv.Rows)
                {
                    ...
                    //row.Attributes["onMouseDown"] = "this.orignalclassName = this.className;this.className = 'selectedrow';";
